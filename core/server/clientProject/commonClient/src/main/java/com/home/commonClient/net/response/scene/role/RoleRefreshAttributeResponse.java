package com.home.commonClient.net.response.scene.role;
...
{
	/** 数据类型ID */
	public static final int dataID=GameResponseType.RoleRefreshAttribute;
	...
	{
		_dataID=GameResponseType.RoleRefreshAttribute;
	}
