...
public class GiveUpQuestRequest extends GameRequest
{
	/** 数据类型ID */
	public static final int dataID=GameRequestType.GiveUpQuest;
	
	/** 任务id */
	public int id;
	
	public GiveUpQuestRequest()
	{
		_dataID=GameRequestType.GiveUpQuest;
	}
