...
public class SendInfoCodeWithArgsFromCenterResponse extends CenterResponse
{
	/** 数据类型ID */
	public static final int dataID=CenterResponseType.SendInfoCodeWithArgsFromCenter;
	...
	public SendInfoCodeWithArgsFromCenterResponse()
	{
		_dataID=CenterResponseType.SendInfoCodeWithArgsFromCenter;
	}
