...
/** (generated by shine) */
public class FuncSendRoleGroupMemberRoleShowChangeResponse extends FuncPlayerRoleGroupSResponse
{
	/** 数据类型ID */
	public static final int dataID=GameResponseType.FuncSendRoleGroupMemberRoleShowChange;
