...
public class MUnitRefreshAvatarResponse extends MUnitSResponse
{
	/** 数据类型ID */
	public static final int dataID=GameResponseType.MUnitRefreshAvatar;
	...
	public MUnitRefreshAvatarResponse()
	{
		_dataID=GameResponseType.MUnitRefreshAvatar;
	}
	...
	{
		mLogic.getFightLogic().avatar.setAvatarByServer(modelID,parts);
	}
