...
public class RefuseApplyAddFriendRequest extends GameRequest
{
	/** 数据类型ID */
	public static final int dataID=GameRequestType.RefuseApplyAddFriend;
	
	/** 角色ID */
	public long playerID;
	
	public RefuseApplyAddFriendRequest()
	{
		_dataID=GameRequestType.RefuseApplyAddFriend;
	}
