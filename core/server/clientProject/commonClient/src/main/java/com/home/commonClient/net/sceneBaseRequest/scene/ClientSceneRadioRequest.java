package com.home.commonClient.net.sceneBaseRequest.scene;
...
{
	/** 数据类型ID */
	public static final int dataID=SceneBaseRequestType.ClientSceneRadio;
	...
	{
		_dataID=SceneBaseRequestType.ClientSceneRadio;
	}
