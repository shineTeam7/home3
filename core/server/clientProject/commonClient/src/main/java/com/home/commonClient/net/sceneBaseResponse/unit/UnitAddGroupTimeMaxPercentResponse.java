...
public class UnitAddGroupTimeMaxPercentResponse extends UnitSResponse
{
	/** 数据类型ID */
	public static final int dataID=SceneBaseResponseType.UnitAddGroupTimeMaxPercent;
	...
	{
		_dataID=SceneBaseResponseType.UnitAddGroupTimeMaxPercent;
	}
	...
	{
		scene.getFightUnitAbs(instanceID).fight.getCDDataLogic().addGroupTimeMaxPercent(groupID,value);
	}
