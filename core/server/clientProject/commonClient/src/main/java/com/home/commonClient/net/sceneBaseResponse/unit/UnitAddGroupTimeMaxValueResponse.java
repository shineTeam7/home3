...
public class UnitAddGroupTimeMaxValueResponse extends UnitSResponse
{
	/** 数据类型ID */
	public static final int dataID=SceneBaseResponseType.UnitAddGroupTimeMaxValue;
	...
	{
		_dataID=SceneBaseResponseType.UnitAddGroupTimeMaxValue;
	}
	...
	{
		scene.getFightUnitAbs(instanceID).fight.getCDDataLogic().addGroupTimeMaxValue(groupID,value);
	}
