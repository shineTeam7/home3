...
public class FuncResetRankToGameServerRequest extends FuncCenterToGameServerRequest
{
	/** 数据类型ID */
	...
	public FuncResetRankToGameServerRequest()
	{
	...
	{
		return "FuncResetRankToGameServerRequest";
	}
	...
	/** 创建实例 */
	public static FuncResetRankToGameServerRequest create(int funcID,int version)
	{
		FuncResetRankToGameServerRequest re=(FuncResetRankToGameServerRequest)BytesControl.createRequest(dataID);
		re.funcID=funcID;
		re.version=version;
		return re;
	}
