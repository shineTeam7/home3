...
public class FuncSendAuctionBuyItemToCenterServerResponse extends FuncPlayerToCenterServerResponse
{
	/** 玩家数据 */
	...
	public FuncSendAuctionBuyItemToCenterServerResponse()
	{
	...
	{
		return "FuncSendAuctionBuyItemToCenterServerResponse";
	}
	...
	{
		CenterC.global.func.getAuctionTool(funcID).getExecutor(_poolIndex).buyItem(roleData,data);
	}
