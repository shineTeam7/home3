...
public class MAddPlayerWorkToCenterServerResponse extends ManagerToCenterServerResponse
{
	/** 数据类型ID */
	...
	public MAddPlayerWorkToCenterServerResponse()
	{
	...
	{
		return "MAddPlayerWorkToCenterServerResponse";
	}
	...
	{
		CenterC.main.addPlayerOfflineWorkByGM(httpID,data);
	}
