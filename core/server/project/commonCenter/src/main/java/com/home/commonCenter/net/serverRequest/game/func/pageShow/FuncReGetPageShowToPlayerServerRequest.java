package com.home.commonCenter.net.serverRequest.game.func.pageShow;
...
/** (generated by shine) */
public class FuncReGetPageShowToPlayerServerRequest extends FuncPlayerToGameServerRequest
{
	/** 数据类型ID */
	public static final int dataID=ServerMessageType.FuncReGetPageShowToPlayer;
	...
	public FuncReGetPageShowToPlayerServerRequest()
	{
		_dataID=ServerMessageType.FuncReGetPageShowToPlayer;
	}
	...
	{
		return "FuncReGetPageShowToPlayerServerRequest";
	}
	...
	/** 创建实例 */
	public static FuncReGetPageShowToPlayerServerRequest create(int funcID,int page,int arg,SList<KeyData> list,RankData rankData)
	{
		FuncReGetPageShowToPlayerServerRequest re=(FuncReGetPageShowToPlayerServerRequest)BytesControl.createRequest(dataID);
		re.funcID=funcID;
		re.page=page;
		re.arg=arg;
		re.list=list;
