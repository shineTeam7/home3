...
public class UkcpServerBootstrap extends AbstractBootstrap<UkcpServerBootstrap,UkcpServerChannel> implements
        Cloneable,IUkcpServerBootstrap
{
    ...
    public void nodelay(boolean nodelay, int interval, int fastResend,boolean nocwnd) {
        this.childOption(UkcpChannelOption.UKCP_NODELAY, nodelay)
