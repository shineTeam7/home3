...
import com.home.shine.net.kcp.netty.internal.ReItrHashMap;
import com.home.shine.net.kcp.netty.internal.ReusableIterator;
...
public final class UkcpServerChannel extends AbstractNioMessageChannel implements ServerChannel, Runnable {
    ...
    private static final InternalLogger sheduleUpdateLog = InternalLoggerFactory.getInstance("com.home.shine.net.kcp.netty" +
            ".sheduleUpdate");
    ...
    private UkcpServerChildChannel getUkcpChannel(InetSocketAddress remoteAddress) {
        return childChannelMap.get(remoteAddress);
    }
    ...
    private UkcpServerChildChannel createChildChannel(InetSocketAddress remoteAddress, int conv) {
            ...
            try {
                ...
                for (int i = 0; i < readBufSize; i++) {
                    ...
                    if (closeWaitKcp != null) {
                        ...
                        UkcpServerChildChannel childCh = getUkcpChannel(remoteAddress);
                        if(childCh == null){
                            byteBuf.markReaderIndex();
                            int conv = byteBuf.readIntLE();
                            byteBuf.resetReaderIndex();
                            childCh = createChildChannel(remoteAddress, conv);
                        }
