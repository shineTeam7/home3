...
public class PlayerPreExitToGameServerResponse extends GameToGameServerResponse
{
	/** 数据类型ID */
	...
	public PlayerPreExitToGameServerResponse()
	{
	...
	{
		return "PlayerPreExitToGameServerResponse";
	}
	...
	{
		GameC.gameSwitch.sourcePlayerPreExit(playerID,fromGameID);
	}
