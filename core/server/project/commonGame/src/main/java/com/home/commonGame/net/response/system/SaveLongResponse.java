...
public class SaveLongResponse extends GameResponse
{
	/** 数据类型ID */
	public static final int dataID=GameResponseType.SaveLong;
	...
	public SaveLongResponse()
	{
		_dataID=GameResponseType.SaveLong;
	}
	...
	{
		me.system.getPartData().keepSave.longDic.put(key,value);
	}
