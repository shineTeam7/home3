package com.home.commonGame.net.serverResponse.center.func.pageShow;
...
/** (generated by shine) */
public class FuncReGetPageShowToPlayerServerResponse extends FuncPlayerToGameServerResponse
{
	/** 数据类型ID */
	...
	public FuncReGetPageShowToPlayerServerResponse()
	{
	...
	{
		return "FuncReGetPageShowToPlayerServerResponse";
	}
