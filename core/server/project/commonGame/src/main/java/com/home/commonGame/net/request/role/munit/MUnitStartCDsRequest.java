...
public class MUnitStartCDsRequest extends MUnitSRequest
{
	/** 数据类型ID */
	public static final int dataID=GameRequestType.MUnitStartCDs;
	
	/** 冷却组 */
	public SList<CDData> cds;
	
	public MUnitStartCDsRequest()
	{
		_dataID=GameRequestType.MUnitStartCDs;
	}
	...
	/** 创建实例 */
	public static MUnitStartCDsRequest create(int mIndex,SList<CDData> cds)
	{
		MUnitStartCDsRequest re=(MUnitStartCDsRequest)BytesControl.createRequest(dataID);
		re.mIndex=mIndex;
		re.cds=cds;
		return re;
	}
