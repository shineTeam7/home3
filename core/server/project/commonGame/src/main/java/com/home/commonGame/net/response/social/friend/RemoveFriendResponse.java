...
public class RemoveFriendResponse extends GameResponse
{
	/** 数据类型ID */
	public static final int dataID=GameResponseType.RemoveFriend;
	...
	{
		_dataID=GameResponseType.RemoveFriend;
