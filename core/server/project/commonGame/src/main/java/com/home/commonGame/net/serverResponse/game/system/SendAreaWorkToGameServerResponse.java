...
/** (generated by shine) */
public class SendAreaWorkToGameServerResponse extends GameToGameServerResponse
{
	/** 数据类型ID */
	...
	public SendAreaWorkToGameServerResponse()
	{
	...
	{
		return "SendAreaWorkToGameServerResponse";
	}
