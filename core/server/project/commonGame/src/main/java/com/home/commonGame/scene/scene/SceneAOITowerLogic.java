...
/** 25宫灯塔AOILogic */
public class SceneAOITowerLogic extends GameSceneAOILogic
{
	/** 25宫 */
	...
	public void init()
	{
		...
		_pool=_gameScene.getGameExecutor().towerDataPool;
	...
	public void unitRefreshPos(Unit unit)
	{
		...
		int tx=countTowerX(pos.x);
		int tz=countTowerZ(pos.z);
