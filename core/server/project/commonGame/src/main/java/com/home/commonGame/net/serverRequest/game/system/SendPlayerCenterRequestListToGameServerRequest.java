...
/** (generated by shine) */
public class SendPlayerCenterRequestListToGameServerRequest extends GameToGameServerRequest
{
	/** 数据类型ID */
	...
	public SendPlayerCenterRequestListToGameServerRequest()
	{
	...
	{
		return "SendPlayerCenterRequestListToGameServerRequest";
	}
	...
	/** 创建实例 */
	public static SendPlayerCenterRequestListToGameServerRequest create(long playerID,byte[][] data)
	{
		SendPlayerCenterRequestListToGameServerRequest re=(SendPlayerCenterRequestListToGameServerRequest)BytesControl.createRequest(dataID);
