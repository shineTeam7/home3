...
/** (generated by shine) */
public class PlayerToGameTransCenterToGameServerResponse extends CenterToGameServerResponse
{
	/** 数据类型ID */
	...
	public PlayerToGameTransCenterToGameServerResponse()
	{
	...
	{
		return "PlayerToGameTransCenterToGameServerResponse";
	}
