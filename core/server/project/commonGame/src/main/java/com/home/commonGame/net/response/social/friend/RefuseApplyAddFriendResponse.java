...
public class RefuseApplyAddFriendResponse extends GameResponse
{
	/** 数据类型ID */
	public static final int dataID=GameResponseType.RefuseApplyAddFriend;
	
	/** 角色ID */
	public long playerID;
	
	public RefuseApplyAddFriendResponse()
	{
		_dataID=GameResponseType.RefuseApplyAddFriend;
	...
	{
		me.friend.refuseApplyAddFriend(playerID);
	}
	...
	{
		return "RefuseApplyAddFriendResponse";
	}
