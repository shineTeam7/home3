...
public class SaveIntResponse extends GameResponse
{
	/** 数据类型ID */
	public static final int dataID=GameResponseType.SaveInt;
	...
	public SaveIntResponse()
	{
		_dataID=GameResponseType.SaveInt;
	}
	...
	{
		me.system.getPartData().keepSave.intDic.put(key,value);
	}
