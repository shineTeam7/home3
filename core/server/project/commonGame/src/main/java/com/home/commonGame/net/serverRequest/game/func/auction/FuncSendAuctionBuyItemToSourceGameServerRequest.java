...
public class FuncSendAuctionBuyItemToSourceGameServerRequest extends FuncToGameServerRequest
{
	/** 玩家数据 */
	...
	public FuncSendAuctionBuyItemToSourceGameServerRequest()
	{
	...
	{
		return "FuncSendAuctionBuyItemToSourceGameServerRequest";
	}
	...
	/** 创建实例 */
	public static FuncSendAuctionBuyItemToSourceGameServerRequest create(int funcID,RoleSimpleShowData roleData,AuctionBuyItemData data)
	{
		FuncSendAuctionBuyItemToSourceGameServerRequest re=(FuncSendAuctionBuyItemToSourceGameServerRequest)BytesControl.createRequest(dataID);
		re.funcID=funcID;
