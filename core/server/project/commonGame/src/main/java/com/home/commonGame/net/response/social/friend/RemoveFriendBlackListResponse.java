...
public class RemoveFriendBlackListResponse extends GameResponse
{
	/** 数据类型ID */
	public static final int dataID=GameResponseType.RemoveFriendBlackList;
	
	public long playerID;
	
	public RemoveFriendBlackListResponse()
	{
		_dataID=GameResponseType.RemoveFriendBlackList;
	...
	{
		me.friend.removeBlackList(playerID);
	}
	...
	{
		return "RemoveFriendBlackListResponse";
	}
