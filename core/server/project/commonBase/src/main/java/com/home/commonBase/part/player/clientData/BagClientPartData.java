...
public class BagClientPartData extends BaseClientPartData
{
	/** 数据类型ID */
	public static final int dataID=PlayerPartClientDataType.Bag;
	
	public BagClientPartData()
	{
		_dataID=PlayerPartClientDataType.Bag;
	}
