...
/** 带角色外线日志数据(generated by shine) */
public class RoleShowLogData extends InfoLogData
{
	/** 数据类型ID */
	public static final int dataID=BaseDataType.RoleShowLog;
	
	/** 角色外显数据 */
	public RoleShowData showData;
	
	public RoleShowLogData()
	{
		_dataID=BaseDataType.RoleShowLog;
	}
	...
	protected void toShadowCopy(BaseData data)
	{
		...
		if(!(data instanceof RoleShowLogData))
			return;
		
		RoleShowLogData mData=(RoleShowLogData)data;
