...
/** (generated by shine) */
public class TeamClientPartData extends BaseClientPartData
{
	/** 数据类型ID */
	public static final int dataID=PlayerPartClientDataType.Team;
	
	public TeamClientPartData()
	{
		_dataID=PlayerPartClientDataType.Team;
	}
