...
public class QuestClientPartData extends BaseClientPartData
{
	/** 客户端目标实例ID序号 */
	...
	/** 数据类型ID */
	public static final int dataID=PlayerPartClientDataType.Quest;
	
	public QuestClientPartData()
	{
		_dataID=PlayerPartClientDataType.Quest;
	}
	...
	protected void toShadowCopy(BaseData data)
	{
		...
		if(!(data instanceof QuestClientPartData))
			return;
		
		QuestClientPartData mData=(QuestClientPartData)data;
