...
/** 游戏服邮件数据(generated by shine) */
public class GameMailPartData extends BaseData
{
	/** 邮件组 */
	public SList<MailData> mails;
	
	/** 数据类型ID */
	public static final int dataID=GameGlobalPartDataType.GameMail;
	
	public GameMailPartData()
	{
		_dataID=GameGlobalPartDataType.GameMail;
	}
	...
	{
		if(!(data instanceof GameMailPartData))
			return;
		
		GameMailPartData mData=(GameMailPartData)data;
