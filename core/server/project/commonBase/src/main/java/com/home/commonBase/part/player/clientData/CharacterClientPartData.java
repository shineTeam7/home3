...
/** (generated by shine) */
public class CharacterClientPartData extends BaseClientPartData
{
	/** 数据类型ID */
	public static final int dataID=PlayerPartClientDataType.Character;
	
	public CharacterClientPartData()
	{
		_dataID=PlayerPartClientDataType.Character;
	}
	...
	{
		return "CharacterClientPartData";
	}
