...
/** (generated by shine) */
public class EquipClientPartData extends BaseClientPartData
{
	/** 数据类型ID */
	public static final int dataID=PlayerPartClientDataType.Equip;
	
	public EquipClientPartData()
	{
		_dataID=PlayerPartClientDataType.Equip;
	}
