...
/** (generated by shine) */
public class RePlayerLoginFromEachGameData extends BaseData
{
	/** 数据类型ID */
	public static final int dataID=BaseDataType.RePlayerLoginFromEachGame;
	...
	/** 超时的逻辑服组 */
	public IntSet timeOutGames;
	
	public RePlayerLoginFromEachGameData()
	{
		_dataID=BaseDataType.RePlayerLoginFromEachGame;
	}
	...
	{
		return "RePlayerLoginFromEachGameData";
	}
	...
	protected void toShadowCopy(BaseData data)
	{
		...
		RePlayerLoginFromEachGameData mData=(RePlayerLoginFromEachGameData)data;
