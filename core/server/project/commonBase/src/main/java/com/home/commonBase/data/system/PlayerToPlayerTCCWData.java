...
public class PlayerToPlayerTCCWData extends PlayerWorkData
{
	/** 发起者角色ID */
	public long sendPlayerID;
	
	/** 数据类型ID */
	public static final int dataID=BaseDataType.PlayerToPlayerTCCW;
	
	public PlayerToPlayerTCCWData()
	{
		_dataID=BaseDataType.PlayerToPlayerTCCW;
	}
	...
	protected void toShadowCopy(BaseData data)
	{
		...
		PlayerToPlayerTCCWData mData=(PlayerToPlayerTCCWData)data;
