...
/** (generated by shine) */
public class SceneInitServerData extends BaseData
{
	/** 数据类型ID */
	public static final int dataID=BaseDataType.SceneInitServer;
	...
	public SceneInitServerData()
	{
		_dataID=BaseDataType.SceneInitServer;
	}
	...
	{
		if(!(data instanceof SceneInitServerData))
			return;
		
		SceneInitServerData mData=(SceneInitServerData)data;
