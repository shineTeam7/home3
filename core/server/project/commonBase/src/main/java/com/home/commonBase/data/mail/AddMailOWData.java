...
public class AddMailOWData extends PlayerWorkData
{
	/** 数据类型ID */
	public static final int dataID=BaseDataType.AddMailOW;
	
	/** 邮件数据 */
	public MailData data;
	
	public AddMailOWData()
	{
		_dataID=BaseDataType.AddMailOW;
	}
	...
	protected void toReadBytesFull(BytesReadStream stream)
	{
		...
		if(dataT!=null)
		{
			...
			else
			{
				...
				if(!(dataT.getClass().isAssignableFrom(MailData.class)))
				{
					stream.throwTypeReadError(MailData.class,dataT.getClass());
				}
	...
	protected void toShadowCopy(BaseData data)
	{
		...
		AddMailOWData mData=(AddMailOWData)data;
	...
	protected void toCopy(BaseData data)
	{
		...
		if(mData.data!=null)
		{
			this.data=(MailData)mData.data.clone();
		}
		else
		{
			this.data=null;
