...
public class SocialClientPartData extends BaseClientPartData
{
	/** 多频道组 */
	...
	/** 数据类型ID */
	public static final int dataID=PlayerPartClientDataType.Social;
	
	public SocialClientPartData()
	{
		_dataID=PlayerPartClientDataType.Social;
	}
	...
	protected void toShadowCopy(BaseData data)
	{
		...
		if(!(data instanceof SocialClientPartData))
			return;
		
		SocialClientPartData mData=(SocialClientPartData)data;
