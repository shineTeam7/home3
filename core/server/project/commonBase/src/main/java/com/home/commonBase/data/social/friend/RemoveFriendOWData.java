...
public class RemoveFriendOWData extends PlayerWorkData
{
	/** 数据类型ID */
	public static final int dataID=BaseDataType.RemoveFriendOW;
	
	public long playerID;
	
	public RemoveFriendOWData()
	{
		_dataID=BaseDataType.RemoveFriendOW;
	}
	...
	protected void toShadowCopy(BaseData data)
	{
		...
		RemoveFriendOWData mData=(RemoveFriendOWData)data;
