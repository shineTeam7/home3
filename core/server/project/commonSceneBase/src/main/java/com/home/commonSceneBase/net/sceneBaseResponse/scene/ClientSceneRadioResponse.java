package com.home.commonSceneBase.net.sceneBaseResponse.scene;
...
{
	/** 数据类型ID */
	public static final int dataID=SceneBaseResponseType.ClientSceneRadio;
	...
	{
		_dataID=SceneBaseResponseType.ClientSceneRadio;
	}
	...
	protected void execute()
	{
		...
		scene.aoi.radioMessageAll(SceneRadioRequest.create(data));
	}
