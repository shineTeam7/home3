...
public class UnitSyncCommandRequest extends UnitSRequest
{
	/** 数据类型ID */
	public static final int dataID=SceneBaseRequestType.UnitSyncCommand;
	...
	public UnitSyncCommandRequest()
	{
		_dataID=SceneBaseRequestType.UnitSyncCommand;
		setDontCopy();
	}
	...
	/** 创建实例 */
	public static UnitSyncCommandRequest create(int instanceID,PosDirData posDir,int type,int[] ints,float[] floats)
	{
		UnitSyncCommandRequest re=(UnitSyncCommandRequest)BytesControl.createRequest(dataID);
