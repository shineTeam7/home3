...
{
	/** 数据类型ID */
	public static final int dataID=SceneBaseResponseType.CUnitR;
	...
	{
		_dataID=SceneBaseResponseType.CUnitR;
	}
	...
	protected void preExecute()
	{
		...
		if((unit=scene.getPlayerControlUnit(_playerID,instanceID))==null)
			return;
