...
#ifndef RECASTSAMPLESHINE_H
#define RECASTSAMPLESHINE_H
...
#ifdef __APPLE__
const string DirFront = "../../../Bin/";
#else
const string DirFront = "";
#endif
...
class Sample_Shine : public Sample
{
protected:
