...
Sample* createShine() { return new Sample_Shine(); }
...
int main(int /*argc*/, char** /*argv*/)
{
	...
	const char* ttfPath=(DirFront+"DroidSans.ttf").c_str();

	if (!imguiRenderGLInit(ttfPath))
	{
	...
	vector<string> files;
	const string meshesFolder =(DirFront+"Meshes").c_str();
