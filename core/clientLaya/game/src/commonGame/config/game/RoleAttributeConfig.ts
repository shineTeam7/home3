namespace Shine
{
	...
	export class RoleAttributeConfig extends BaseConfig
	{
		/** 存储集合 */
		private static _dic:RoleAttributeConfig[];
		...
		/** 获取 */
		public static get(id:number):RoleAttributeConfig
		{
			return id>=0 && id<this._dic.length ? this._dic[id] : null;
		}
		
		/** 添加字典(热更用) */
		public static addDic(dic:RoleAttributeConfig[]):void
		{
			ObjectUtils.arrayPutAll(this._dic,dic);
		}
		
		/** 设置字典 */
		public static setDic(dic:RoleAttributeConfig[]):void
		{
			this._dic=dic;
		}
		
		/** 获取全部 */
		public static getDic():RoleAttributeConfig[]
		{
			return this._dic;
		}
