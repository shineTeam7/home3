namespace Shine
{
	...
	export class RoleShowLogData extends InfoLogData
	{
		/** 数据类型ID */
		public static dataID:number=BaseDataType.RoleShowLog;
		...
		{
			super();
			this._dataID=BaseDataType.RoleShowLog;
		}
		...
		protected toShadowCopy(data:BaseData):void
		{
			...
			var mData:RoleShowLogData=data as RoleShowLogData;
