...
{
	/** (generated by shine) */
	export class TriggerIntData extends TriggerObjData
	{
		/** 数据类型ID */
		public static dataID:number=ShineDataType.TriggerInt;
		...
		{
			super();
			this._dataID=ShineDataType.TriggerInt;
		}
		...
		protected toShadowCopy(data:BaseData):void
		{
			...
			var mData:TriggerIntData=data as TriggerIntData;
