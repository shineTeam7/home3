...
namespace Quartz
{
    ...
    public static class QuartzEnvironment
    {
        ...
        public static string GetEnvironmentVariable(string key)
        {
            ...
            {
                Debug.Log("Unable to read environment variable '{0}' due to security exception, probably running under medium trust:"+key);
            }
            return null;
        }
        ...
        public static IDictionary<string, string> GetEnvironmentVariables()
        {
            ...
            {
                Debug.Log("Unable to read environment variables due to security exception, probably running under medium trust");
            }
            return retValue;
        }
    }
