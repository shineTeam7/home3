...
namespace ShineEngine
{
	...
	/// 滑动容器
	/// </summary>
	public class UISScrollViewFake3D<T>:UIGridContainer<T>where T:UIObject,new()
	{
		...
		private SScrollViewFake3D _scrollView;

		public UISScrollViewFake3D()
		{
			_type=UIElementType.SScrollViewFake3D;
		}

		public SScrollViewFake3D scrollView
		{
		...
		public override void init(GameObject obj)
		{
			...
			_scrollView=obj.GetComponent<SScrollViewFake3D>();
			_scrollView.init();
            ...
            _scrollView.setEndAction(SetScrollCallback);
		}
        ...
        {
            _scrollView.SetScrollBack(completeAction);
        }

        public int GetCurrentGridIndex()
        {
            return _scrollView.GetCurrentGridIndex();
        }
	}
}