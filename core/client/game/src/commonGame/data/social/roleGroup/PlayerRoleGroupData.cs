...
/// </summary>
public class PlayerRoleGroupData:BaseData
{
	/// <summary>
	/// 数据类型ID
	/// </summary>
	public const int dataID=BaseDataType.PlayerRoleGroup;
	...
	public PlayerRoleGroupData()
	{
		_dataID=BaseDataType.PlayerRoleGroup;
	}
	...
	{
		if(!(data is PlayerRoleGroupData))
			return;
		
		PlayerRoleGroupData mData=(PlayerRoleGroupData)data;
