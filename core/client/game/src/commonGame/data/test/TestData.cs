...
public class TestData:BaseData
{
	...
	/// 数据类型ID
	/// </summary>
	public const int dataID=BaseDataType.Test;
	...
	protected override void toReadBytesSimple(BytesReadStream stream)
	{
		...
		{
			this.e2=new IntObjectMap<Test2Data>(e2Len);
		}
		...
		{
			this.e3=new LongObjectMap<Test2Data>(e3Len);
		}
		...
		{
			this.e5=new IntObjectMap<Test2Data>(e5Len);
		}
		...
		{
			this.e6=new IntObjectMap<Test2Data>(e6Len);
		}
		...
		{
			this.e7=new IntObjectMap<Test2Data>(e7Len);
		}
		...
		{
			this.e8=new IntObjectMap<Test2Data>(e8Len);
		}
		...
		{
			this.f3=new SList<Test2Data>[f3Len];
		}
		...
		{
			this.f4=new SList<Test2Data[]>[f4Len];
		}
		...
		if(stream.readBoolean())
		{
			...
			{
				this.f5=new SList<Test2Data>[f5Len];
			}
		...
		if(stream.readBoolean())
		{
			...
			{
				this.f6=new SList<Test2Data[]>[f6Len];
			}
		...
		{
			this.g1=new IntObjectMap<IntObjectMap<Test2Data>>(g1Len);
		}
		...
		for(int g1I=g1Len-1;g1I>=0;--g1I)
		{
			...
			g1V=new IntObjectMap<Test2Data>(g1VLen);
		...
		{
			this.h3=new IntObjectMap<SQueue<Test2Data>>(h3Len);
		}
	...
	protected override void toWriteBytesSimple(BytesWriteStream stream)
	{
		...
		if(this.d3!=null)
		{
			...
			if(!this.d3.isEmpty())
			{
				string[] d3VValues=this.d3.getValues();
				for(int d3VI=0,d3VLen=this.d3.length();d3VI<d3VLen;++d3VI)
				{
					string d3V=d3VValues[d3VI];
					stream.writeUTF(d3V);
		...
		if(this.d4!=null)
		{
			...
			if(!this.d4.isEmpty())
			{
				Test2Data[] d4VValues=this.d4.getValues();
				for(int d4VI=0,d4VLen=this.d4.length();d4VI<d4VLen;++d4VI)
				{
					Test2Data d4V=d4VValues[d4VI];
					if(d4V!=null)
					{
		...
		if(this.d5!=null)
		{
			...
			if(!this.d5.isEmpty())
			{
				Test2Data[] d5VValues=this.d5.getValues();
				for(int d5VI=0,d5VLen=this.d5.length();d5VI<d5VLen;++d5VI)
				{
					Test2Data d5V=d5VValues[d5VI];
					if(d5V!=null)
					{
		...
		if(this.d6!=null)
		{
			...
			if(!this.d6.isEmpty())
			{
				Test2Data[] d6VValues=this.d6.getValues();
				for(int d6VI=0,d6VLen=this.d6.length();d6VI<d6VLen;++d6VI)
				{
					Test2Data d6V=d6VValues[d6VI];
					if(d6V!=null)
					{
						stream.writeBoolean(true);
		...
		if(this.e1!=null)
		{
			...
			if(!this.e1.isEmpty())
			{
				...
				int[] e1KKeys=this.e1.getKeys();
				int[] e1VValues=this.e1.getValues();
				for(int e1KI=e1KKeys.Length-1;e1KI>=0;--e1KI)
				{
					int e1K=e1KKeys[e1KI];
					if(e1K!=e1KFreeValue)
					{
						int e1V=e1VValues[e1KI];
						stream.writeInt(e1K);
		...
		if(this.e2!=null)
		{
			...
			if(!this.e2.isEmpty())
			{
				...
				Test2Data[] e2VValues=this.e2.getValues();
				for(int e2KI=e2KKeys.Length-1;e2KI>=0;--e2KI)
				{
					int e2K=e2KKeys[e2KI];
					if(e2K!=e2KFreeValue)
					{
						Test2Data e2V=e2VValues[e2KI];
						stream.writeInt(e2K);
		...
		if(this.e3!=null)
		{
			...
			if(!this.e3.isEmpty())
			{
				...
				Test2Data[] e3VValues=this.e3.getValues();
				for(int e3KI=e3KKeys.Length-1;e3KI>=0;--e3KI)
				{
					long e3K=e3KKeys[e3KI];
					if(e3K!=e3KFreeValue)
					{
						Test2Data e3V=e3VValues[e3KI];
		...
		if(this.e4!=null)
		{
			...
			if(!this.e4.isEmpty())
			{
				string[] e4KKeys=this.e4.getKeys();
				Test2Data[] e4VValues=this.e4.getValues();
				for(int e4KI=e4KKeys.Length-1;e4KI>=0;--e4KI)
				{
					string e4K=e4KKeys[e4KI];
					if(e4K!=null)
					{
						Test2Data e4V=e4VValues[e4KI];
						stream.writeUTF(e4K);
		...
		if(this.e5!=null)
		{
			...
			if(!this.e5.isEmpty())
			{
				...
				Test2Data[] e5VValues=this.e5.getValues();
				for(int e5KI=e5KKeys.Length-1;e5KI>=0;--e5KI)
				{
					int e5K=e5KKeys[e5KI];
					if(e5K!=e5KFreeValue)
					{
						Test2Data e5V=e5VValues[e5KI];
						stream.writeInt(e5K);
		...
		if(this.e6!=null)
		{
			...
			if(!this.e6.isEmpty())
			{
				Test2Data[] e6VValues=this.e6.getValues();
				for(int e6VI=e6VValues.Length-1;e6VI>=0;--e6VI)
				{
					Test2Data e6V=e6VValues[e6VI];
					if(e6V!=null)
					{
						if(e6V!=null)
						{
		...
		if(this.e7!=null)
		{
			...
			if(!this.e7.isEmpty())
			{
				Test2Data[] e7VValues=this.e7.getValues();
				for(int e7VI=e7VValues.Length-1;e7VI>=0;--e7VI)
				{
					Test2Data e7V=e7VValues[e7VI];
					if(e7V!=null)
					{
						if(e7V!=null)
						{
		...
		if(this.e8!=null)
		{
			...
			if(!this.e8.isEmpty())
			{
				Test2Data[] e8VValues=this.e8.getValues();
				for(int e8VI=e8VValues.Length-1;e8VI>=0;--e8VI)
				{
					Test2Data e8V=e8VValues[e8VI];
					if(e8V!=null)
					{
						if(e8V!=null)
						{
		...
		if(this.f3!=null)
		{
			...
			for(int f3VI=0,f3VLen=f3T.Length;f3VI<f3VLen;++f3VI)
			{
				...
				if(f3V!=null)
				{
					...
					if(!f3V.isEmpty())
					{
						Test2Data[] f3VVValues=f3V.getValues();
						for(int f3VVI=0,f3VVLen=f3V.length();f3VVI<f3VVLen;++f3VVI)
						{
							Test2Data f3VV=f3VVValues[f3VVI];
							if(f3VV!=null)
							{
		...
		if(this.f4!=null)
		{
			...
			for(int f4VI=0,f4VLen=f4T.Length;f4VI<f4VLen;++f4VI)
			{
				...
				if(f4V!=null)
				{
					...
					if(!f4V.isEmpty())
					{
						Test2Data[][] f4VVValues=f4V.getValues();
						for(int f4VVI=0,f4VVLen=f4V.length();f4VVI<f4VVLen;++f4VVI)
						{
							Test2Data[] f4VV=f4VVValues[f4VVI];
							if(f4VV!=null)
							{
								Test2Data[] f4VVT=f4VV;
		...
		if(this.f5!=null)
		{
			...
			for(int f5VI=0,f5VLen=f5T.Length;f5VI<f5VLen;++f5VI)
			{
				...
				if(f5V!=null)
				{
					...
					if(!f5V.isEmpty())
					{
						Test2Data[] f5VVValues=f5V.getValues();
						for(int f5VVI=0,f5VVLen=f5V.length();f5VVI<f5VVLen;++f5VVI)
						{
							Test2Data f5VV=f5VVValues[f5VVI];
							if(f5VV!=null)
							{
								stream.writeBoolean(true);
		...
		if(this.f6!=null)
		{
			...
			for(int f6VI=0,f6VLen=f6T.Length;f6VI<f6VLen;++f6VI)
			{
				...
				if(f6V!=null)
				{
					...
					if(!f6V.isEmpty())
					{
						Test2Data[][] f6VVValues=f6V.getValues();
						for(int f6VVI=0,f6VVLen=f6V.length();f6VVI<f6VVLen;++f6VVI)
						{
							Test2Data[] f6VV=f6VVValues[f6VVI];
							if(f6VV!=null)
							{
								stream.writeBoolean(true);
								Test2Data[] f6VVT=f6VV;
		...
		if(this.g1!=null)
		{
			...
			if(!this.g1.isEmpty())
			{
				...
				IntObjectMap<Test2Data>[] g1VValues=this.g1.getValues();
				for(int g1KI=g1KKeys.Length-1;g1KI>=0;--g1KI)
				{
					int g1K=g1KKeys[g1KI];
					if(g1K!=g1KFreeValue)
					{
						IntObjectMap<Test2Data> g1V=g1VValues[g1KI];
						stream.writeInt(g1K);
		...
		if(this.h3!=null)
		{
			...
			if(!this.h3.isEmpty())
			{
				...
				SQueue<Test2Data>[] h3VValues=this.h3.getValues();
				for(int h3KI=h3KKeys.Length-1;h3KI>=0;--h3KI)
				{
					int h3K=h3KKeys[h3KI];
					if(h3K!=h3KFreeValue)
					{
						SQueue<Test2Data> h3V=h3VValues[h3KI];
						stream.writeInt(h3K);
	...
	protected override void toCopy(BaseData data)
	{
		...
		if(mData.d3!=null)
		{
			...
			if(!mData.d3.isEmpty())
			{
				string[] d3VValues=mData.d3.getValues();
		...
		if(mData.d4!=null)
		{
			...
			if(!mData.d4.isEmpty())
			{
				Test2Data[] d4VValues=mData.d4.getValues();
		...
		if(mData.d5!=null)
		{
			...
			if(!mData.d5.isEmpty())
			{
				Test2Data[] d5VValues=mData.d5.getValues();
		...
		if(mData.d6!=null)
		{
			...
			if(!mData.d6.isEmpty())
			{
				Test2Data[] d6VValues=mData.d6.getValues();
		...
		if(mData.d9!=null)
		{
			...
			if(!mData.d9.isEmpty())
			{
				string[] d9VKeys=mData.d9.getKeys();
				for(int d9VI=d9VKeys.Length-1;d9VI>=0;--d9VI)
				{
					if(d9VKeys[d9VI]!=null)
					{
		...
		if(mData.d10!=null)
		{
			...
			{
				Test2Data[] d10VKeys=mData.d10.getKeys();
				for(int d10VI=d10VKeys.Length-1;d10VI>=0;--d10VI)
				{
					if(d10VKeys[d10VI]!=null)
					{
		...
		if(mData.d11!=null)
		{
			...
			{
				Test2Data[] d11VKeys=mData.d11.getKeys();
				for(int d11VI=d11VKeys.Length-1;d11VI>=0;--d11VI)
				{
					if(d11VKeys[d11VI]!=null)
					{
		...
		if(mData.e1!=null)
		{
			...
			if(!mData.e1.isEmpty())
			{
				...
				int[] e1KKeys=mData.e1.getKeys();
				int[] e1VValues=mData.e1.getValues();
				for(int e1KI=e1KKeys.Length-1;e1KI>=0;--e1KI)
				{
					int e1K=e1KKeys[e1KI];
					if(e1K!=e1KFreeValue)
		...
		if(mData.e2!=null)
		{
			...
			{
				this.e2=new IntObjectMap<Test2Data>(mData.e2.size());
			}
			...
			if(!mData.e2.isEmpty())
			{
				...
				Test2Data[] e2VValues=mData.e2.getValues();
				for(int e2KI=e2KKeys.Length-1;e2KI>=0;--e2KI)
				{
					int e2K=e2KKeys[e2KI];
					if(e2K!=e2KFreeValue)
		...
		if(mData.e3!=null)
		{
			...
			{
				this.e3=new LongObjectMap<Test2Data>(mData.e3.size());
			}
			...
			if(!mData.e3.isEmpty())
			{
				...
				Test2Data[] e3VValues=mData.e3.getValues();
				for(int e3KI=e3KKeys.Length-1;e3KI>=0;--e3KI)
				{
					long e3K=e3KKeys[e3KI];
					if(e3K!=e3KFreeValue)
		...
		if(mData.e4!=null)
		{
			...
			if(!mData.e4.isEmpty())
			{
				string[] e4KKeys=mData.e4.getKeys();
				Test2Data[] e4VValues=mData.e4.getValues();
				for(int e4KI=e4KKeys.Length-1;e4KI>=0;--e4KI)
				{
					string e4K=e4KKeys[e4KI];
					if(e4K!=null)
		...
		if(mData.e5!=null)
		{
			...
			{
				this.e5=new IntObjectMap<Test2Data>(mData.e5.size());
			}
			...
			if(!mData.e5.isEmpty())
			{
				...
				Test2Data[] e5VValues=mData.e5.getValues();
				for(int e5KI=e5KKeys.Length-1;e5KI>=0;--e5KI)
				{
					int e5K=e5KKeys[e5KI];
					if(e5K!=e5KFreeValue)
		...
		if(mData.e6!=null)
		{
			...
			{
				this.e6=new IntObjectMap<Test2Data>(mData.e6.size());
			}
			
			IntObjectMap<Test2Data> e6T=this.e6;
			if(!mData.e6.isEmpty())
			{
				Test2Data[] e6VValues=mData.e6.getValues();
				for(int e6VI=e6VValues.Length-1;e6VI>=0;--e6VI)
				{
					Test2Data e6V=e6VValues[e6VI];
					if(e6V!=null)
		...
		if(mData.e7!=null)
		{
			...
			{
				this.e7=new IntObjectMap<Test2Data>(mData.e7.size());
			}
			
			IntObjectMap<Test2Data> e7T=this.e7;
			if(!mData.e7.isEmpty())
			{
				Test2Data[] e7VValues=mData.e7.getValues();
				for(int e7VI=e7VValues.Length-1;e7VI>=0;--e7VI)
				{
					Test2Data e7V=e7VValues[e7VI];
					if(e7V!=null)
		...
		if(mData.e8!=null)
		{
			...
			{
				this.e8=new IntObjectMap<Test2Data>(mData.e8.size());
			}
			
			IntObjectMap<Test2Data> e8T=this.e8;
			if(!mData.e8.isEmpty())
			{
				Test2Data[] e8VValues=mData.e8.getValues();
				for(int e8VI=e8VValues.Length-1;e8VI>=0;--e8VI)
				{
					Test2Data e8V=e8VValues[e8VI];
					if(e8V!=null)
		...
		if(mData.f3!=null)
		{
			...
			for(int f3I=0;f3I<f3Len;++f3I)
			{
				...
				if(f3V!=null)
				{
					...
					if(!f3V.isEmpty())
					{
						Test2Data[] f3UVValues=f3V.getValues();
						for(int f3UVI=0,f3UVLen=f3V.length();f3UVI<f3UVLen;++f3UVI)
						{
							Test2Data f3UV=f3UVValues[f3UVI];
							Test2Data f3UU;
							if(f3UV!=null)
							{
		...
		if(mData.f4!=null)
		{
			...
			for(int f4I=0;f4I<f4Len;++f4I)
			{
				...
				if(f4V!=null)
				{
					...
					if(!f4V.isEmpty())
					{
						Test2Data[][] f4UVValues=f4V.getValues();
						for(int f4UVI=0,f4UVLen=f4V.length();f4UVI<f4UVLen;++f4UVI)
						{
							Test2Data[] f4UV=f4UVValues[f4UVI];
							Test2Data[] f4UU;
							if(f4UV!=null)
							{
		...
		if(mData.f5!=null)
		{
			...
			for(int f5I=0;f5I<f5Len;++f5I)
			{
				...
				if(f5V!=null)
				{
					...
					if(!f5V.isEmpty())
					{
						Test2Data[] f5UVValues=f5V.getValues();
						for(int f5UVI=0,f5UVLen=f5V.length();f5UVI<f5UVLen;++f5UVI)
						{
							Test2Data f5UV=f5UVValues[f5UVI];
							Test2Data f5UU;
							if(f5UV!=null)
							{
		...
		if(mData.f6!=null)
		{
			...
			for(int f6I=0;f6I<f6Len;++f6I)
			{
				...
				if(f6V!=null)
				{
					...
					if(!f6V.isEmpty())
					{
						Test2Data[][] f6UVValues=f6V.getValues();
						for(int f6UVI=0,f6UVLen=f6V.length();f6UVI<f6UVLen;++f6UVI)
						{
							Test2Data[] f6UV=f6UVValues[f6UVI];
							Test2Data[] f6UU;
							if(f6UV!=null)
							{
		...
		if(mData.g1!=null)
		{
			...
			{
				this.g1=new IntObjectMap<IntObjectMap<Test2Data>>(mData.g1.size());
			}
			...
			if(!mData.g1.isEmpty())
			{
				...
				IntObjectMap<Test2Data>[] g1VValues=mData.g1.getValues();
				for(int g1KI=g1KKeys.Length-1;g1KI>=0;--g1KI)
				{
					int g1K=g1KKeys[g1KI];
					if(g1K!=g1KFreeValue)
		...
		if(mData.h2!=null)
		{
			...
			if(!mData.h2.isEmpty())
			{
				Test2Data[] h2VValues=mData.h2.getValues();
		...
		if(mData.h3!=null)
		{
			...
			{
				this.h3=new IntObjectMap<SQueue<Test2Data>>(mData.h3.size());
			}
			...
			if(!mData.h3.isEmpty())
			{
				...
				SQueue<Test2Data>[] h3VValues=mData.h3.getValues();
				for(int h3KI=h3KKeys.Length-1;h3KI>=0;--h3KI)
				{
					int h3K=h3KKeys[h3KI];
					if(h3K!=h3KFreeValue)
	...
	public override void initDefault()
	{
		...
		this.e2=new IntObjectMap<Test2Data>();
		this.e3=new LongObjectMap<Test2Data>();
		this.e4=new SMap<string,Test2Data>();
		this.e5=new IntObjectMap<Test2Data>();
		this.e6=new IntObjectMap<Test2Data>();
		this.e7=new IntObjectMap<Test2Data>();
		this.e8=new IntObjectMap<Test2Data>();
		this.f1=new IntList[0];
		this.f2=new SList<int[]>[0];
		this.f3=new SList<Test2Data>[0];
		this.f4=new SList<Test2Data[]>[0];
		this.g1=new IntObjectMap<IntObjectMap<Test2Data>>();
		this.h1=new IntQueue();
		this.h2=new SQueue<Test2Data>();
		this.h3=new IntObjectMap<SQueue<Test2Data>>();
	}
	...
	protected override void toReadBytesFull(BytesReadStream stream)
	{
		...
		if(b1T!=null)
		{
			...
			{
				this.b1=new Test2Data();
				if(!(b1T.GetType().IsAssignableFrom(typeof(Test2Data))))
				{
					stream.throwTypeReadError(typeof(Test2Data),b1T.GetType());
				}
		...
		if(b2T!=null)
		{
			...
			{
				this.b2=new Test2Data();
				if(!(b2T.GetType().IsAssignableFrom(typeof(Test2Data))))
				{
					stream.throwTypeReadError(typeof(Test2Data),b2T.GetType());
				}
		...
		if(stream.readBoolean())
		{
			...
			if(b3T!=null)
			{
				...
				else
				{
					...
					if(!(b3T.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),b3T.GetType());
					}
		...
		if(stream.readBoolean())
		{
			...
			if(b4T!=null)
			{
				...
				else
				{
					...
					if(!(b4T.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),b4T.GetType());
					}
		...
		for(int d4I=d4Len-1;d4I>=0;--d4I)
		{
			...
			if(d4VT!=null)
			{
				...
				{
					d4V=new Test2Data();
					if(!(d4VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),d4VT.GetType());
					}
					d4V.shadowCopy(d4VT);
				}
			}
		...
		for(int d5I=d5Len-1;d5I>=0;--d5I)
		{
			...
			if(d5VT!=null)
			{
				...
				{
					d5V=new Test2Data();
					if(!(d5VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),d5VT.GetType());
					}
					d5V.shadowCopy(d5VT);
				}
			}
			...
			for(int d6I=d6Len-1;d6I>=0;--d6I)
			{
				...
				if(stream.readBoolean())
				{
					...
					if(d6VT!=null)
					{
						...
						{
							d6V=new Test2Data();
							if(!(d6VT.GetType().IsAssignableFrom(typeof(Test2Data))))
							{
								stream.throwTypeReadError(typeof(Test2Data),d6VT.GetType());
							}
							d6V.shadowCopy(d6VT);
						}
					}
		...
		for(int d10I=d10Len-1;d10I>=0;--d10I)
		{
			...
			if(d10VT!=null)
			{
				...
				{
					d10V=new Test2Data();
					if(!(d10VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),d10VT.GetType());
					}
		...
		for(int d11I=d11Len-1;d11I>=0;--d11I)
		{
			...
			if(d11VT!=null)
			{
				...
				{
					d11V=new Test2Data();
					if(!(d11VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),d11VT.GetType());
					}
		...
		for(int e2I=e2Len-1;e2I>=0;--e2I)
		{
			...
			if(e2VT!=null)
			{
				...
				{
					e2V=new Test2Data();
					if(!(e2VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),e2VT.GetType());
					}
					e2V.shadowCopy(e2VT);
				}
			}
		...
		for(int e3I=e3Len-1;e3I>=0;--e3I)
		{
			...
			if(e3VT!=null)
			{
				...
				{
					e3V=new Test2Data();
					if(!(e3VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),e3VT.GetType());
					}
					e3V.shadowCopy(e3VT);
				}
			}
		...
		for(int e4I=e4Len-1;e4I>=0;--e4I)
		{
			...
			if(e4VT!=null)
			{
				...
				{
					e4V=new Test2Data();
					if(!(e4VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),e4VT.GetType());
					}
					e4V.shadowCopy(e4VT);
				}
			}
		...
		for(int e5I=e5Len-1;e5I>=0;--e5I)
		{
			...
			if(e5VT!=null)
			{
				...
				{
					e5V=new Test2Data();
					if(!(e5VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),e5VT.GetType());
					}
					e5V.shadowCopy(e5VT);
				}
			}
		...
		for(int e6I=e6Len-1;e6I>=0;--e6I)
		{
			...
			if(e6VT!=null)
			{
				...
				{
					e6V=new Test2Data();
					if(!(e6VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),e6VT.GetType());
					}
					e6V.shadowCopy(e6VT);
				}
			}
		...
		for(int e7I=e7Len-1;e7I>=0;--e7I)
		{
			...
			if(e7VT!=null)
			{
				...
				{
					e7V=new Test2Data();
					if(!(e7VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),e7VT.GetType());
					}
					e7V.shadowCopy(e7VT);
				}
			}
		...
		for(int e8I=e8Len-1;e8I>=0;--e8I)
		{
			...
			if(e8VT!=null)
			{
				...
				{
					e8V=new Test2Data();
					if(!(e8VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),e8VT.GetType());
					}
					e8V.shadowCopy(e8VT);
				}
			}
		...
		for(int f3I=0;f3I<f3Len;++f3I)
		{
			...
			for(int f3VI=f3VLen-1;f3VI>=0;--f3VI)
			{
				...
				if(f3VVT!=null)
				{
					...
					{
						f3VV=new Test2Data();
						if(!(f3VVT.GetType().IsAssignableFrom(typeof(Test2Data))))
						{
							stream.throwTypeReadError(typeof(Test2Data),f3VVT.GetType());
						}
			...
			for(int f4VI=f4VLen-1;f4VI>=0;--f4VI)
			{
				...
				for(int f4VVI=0;f4VVI<f4VVLen;++f4VVI)
				{
					...
					if(f4VVVT!=null)
					{
						...
						{
							f4VVV=new Test2Data();
							if(!(f4VVVT.GetType().IsAssignableFrom(typeof(Test2Data))))
							{
								stream.throwTypeReadError(typeof(Test2Data),f4VVVT.GetType());
							}
					...
					for(int f5VI=f5VLen-1;f5VI>=0;--f5VI)
					{
						...
						if(stream.readBoolean())
						{
							...
							if(f5VVT!=null)
							{
								...
								{
									f5VV=new Test2Data();
									if(!(f5VVT.GetType().IsAssignableFrom(typeof(Test2Data))))
									{
										stream.throwTypeReadError(typeof(Test2Data),f5VVT.GetType());
									}
							...
							for(int f6VVI=0;f6VVI<f6VVLen;++f6VVI)
							{
								...
								if(stream.readBoolean())
								{
									...
									if(f6VVVT!=null)
									{
										...
										{
											f6VVV=new Test2Data();
											if(!(f6VVVT.GetType().IsAssignableFrom(typeof(Test2Data))))
											{
												stream.throwTypeReadError(typeof(Test2Data),f6VVVT.GetType());
											}
		...
		for(int g1I=g1Len-1;g1I>=0;--g1I)
		{
			...
			for(int g1VI=g1VLen-1;g1VI>=0;--g1VI)
			{
				...
				if(g1VVT!=null)
				{
					...
					{
						g1VV=new Test2Data();
						if(!(g1VVT.GetType().IsAssignableFrom(typeof(Test2Data))))
						{
							stream.throwTypeReadError(typeof(Test2Data),g1VVT.GetType());
						}
		...
		for(int h2I=h2Len-1;h2I>=0;--h2I)
		{
			...
			if(h2VT!=null)
			{
				...
				{
					h2V=new Test2Data();
					if(!(h2VT.GetType().IsAssignableFrom(typeof(Test2Data))))
					{
						stream.throwTypeReadError(typeof(Test2Data),h2VT.GetType());
					}
					h2V.shadowCopy(h2VT);
				}
			}
		...
		for(int h3I=h3Len-1;h3I>=0;--h3I)
		{
			...
			for(int h3VI=h3VLen-1;h3VI>=0;--h3VI)
			{
				...
				if(h3VVT!=null)
				{
					...
					{
						h3VV=new Test2Data();
						if(!(h3VVT.GetType().IsAssignableFrom(typeof(Test2Data))))
						{
							stream.throwTypeReadError(typeof(Test2Data),h3VVT.GetType());
						}
