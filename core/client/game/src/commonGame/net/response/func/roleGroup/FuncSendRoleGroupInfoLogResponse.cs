...
/// </summary>
public class FuncSendRoleGroupInfoLogResponse:FuncPlayerRoleGroupSResponse
{
	/// <summary>
	/// 数据类型ID
	/// </summary>
	public const int dataID=GameResponseType.FuncSendRoleGroupInfoLog;
