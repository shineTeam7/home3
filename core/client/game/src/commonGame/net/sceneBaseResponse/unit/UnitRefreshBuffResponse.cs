...
/// </summary>
public class UnitRefreshBuffResponse:UnitSResponse
{
	/// <summary>
	/// 数据类型ID
	/// </summary>
	public const int dataID=SceneBaseResponseType.UnitRefreshBuff;
	...
	{
		unit.fight.getBuffLogic().refreshBuffByServer(buffInstanceID,lastTime,lastNum);
	}
