...
using ShineEngine;
	...
	public class ClientOfflineWorkDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ClientOfflineWorkData);
			}
		}
		...
		public class Adaptor : ClientOfflineWorkData, CrossBindingAdaptorType
		{
