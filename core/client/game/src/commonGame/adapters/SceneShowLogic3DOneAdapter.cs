...
using ShineEngine;
	...
	public class SceneShowLogic3DOneAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneShowLogic3DOne);
			}
		}
		...
		public class Adaptor : SceneShowLogic3DOne, CrossBindingAdaptorType
		{
