...
using ShineEngine;
	...
	public class PlayerRoleGroupMemberDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerRoleGroupMemberData);
			}
		}
		...
		public class Adaptor : PlayerRoleGroupMemberData, CrossBindingAdaptorType
		{
