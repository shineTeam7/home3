...
using ShineEngine;
	...
	public class CharacterIdentityDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(CharacterIdentityData);
			}
		}
		...
		public class Adaptor : CharacterIdentityData, CrossBindingAdaptorType
		{
