...
using ShineEngine;
	...
	public class UnitPosLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(UnitPosLogic);
			}
		}
		...
		public class Adaptor : UnitPosLogic, CrossBindingAdaptorType
		{
			...
			bool _g11;
			bool _b11;
			public override void onSetDir()
			{
				if(!_g11)
				{
					_m11=instance.Type.GetMethod("onSetDir",0);
					_g11=true;
				}
			...
			bool _g12;
			bool _b12;
			public override void onSetPos()
			{
				if(!_g12)
				{
					_m12=instance.Type.GetMethod("onSetPos",0);
					_g12=true;
				}
