...
using ShineEngine;
	...
	public class PlayerOfflineCacheExDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerOfflineCacheExData);
			}
		}
		...
		public class Adaptor : PlayerOfflineCacheExData, CrossBindingAdaptorType
		{
