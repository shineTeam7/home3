...
using ShineEngine;
	...
	public class VehicleIdentityDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(VehicleIdentityData);
			}
		}
		...
		public class Adaptor : VehicleIdentityData, CrossBindingAdaptorType
		{
