...
using ShineEngine;
	...
	public class SceneLocationRoleShowChangeDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneLocationRoleShowChangeData);
			}
		}
		...
		public class Adaptor : SceneLocationRoleShowChangeData, CrossBindingAdaptorType
		{
