...
using ShineEngine;
	...
	public class SceneRoleAttributeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneRoleAttributeConfig);
			}
		}
		...
		public class Adaptor : SceneRoleAttributeConfig, CrossBindingAdaptorType
		{
