...
using ShineEngine;
	...
	public class ScenePlaceElementConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ScenePlaceElementConfig);
			}
		}
		...
		public class Adaptor : ScenePlaceElementConfig, CrossBindingAdaptorType
		{
