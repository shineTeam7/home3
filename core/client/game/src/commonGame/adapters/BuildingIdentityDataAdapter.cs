...
using ShineEngine;
	...
	public class BuildingIdentityDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(BuildingIdentityData);
			}
		}
		...
		public class Adaptor : BuildingIdentityData, CrossBindingAdaptorType
		{
