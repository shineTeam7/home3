...
using ShineEngine;
	...
	public class PuppetLevelConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PuppetLevelConfig);
			}
		}
		...
		public class Adaptor : PuppetLevelConfig, CrossBindingAdaptorType
		{
