...
using ShineEngine;
	...
	public class PlayerAuctionToolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerAuctionToolData);
			}
		}
		...
		public class Adaptor : PlayerAuctionToolData, CrossBindingAdaptorType
		{
