...
using ShineEngine;
	...
	public class FuncFromCenterSResponseAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FuncFromCenterSResponse);
			}
		}
		...
		public class Adaptor : FuncFromCenterSResponse, CrossBindingAdaptorType
		{
