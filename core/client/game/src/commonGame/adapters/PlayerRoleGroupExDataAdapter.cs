...
using ShineEngine;
	...
	public class PlayerRoleGroupExDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerRoleGroupExData);
			}
		}
		...
		public class Adaptor : PlayerRoleGroupExData, CrossBindingAdaptorType
		{
