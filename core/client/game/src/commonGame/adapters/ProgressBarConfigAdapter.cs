...
using ShineEngine;
	...
	public class ProgressBarConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ProgressBarConfig);
			}
		}
		...
		public class Adaptor : ProgressBarConfig, CrossBindingAdaptorType
		{
