...
using ShineEngine;
	...
	public class FieldItemBagIdentityDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FieldItemBagIdentityData);
			}
		}
		...
		public class Adaptor : FieldItemBagIdentityData, CrossBindingAdaptorType
		{
