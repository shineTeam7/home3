...
using ShineEngine;
	...
	public class SpecialMoveConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SpecialMoveConfig);
			}
		}
		...
		public class Adaptor : SpecialMoveConfig, CrossBindingAdaptorType
		{
