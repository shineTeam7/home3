...
using ShineEngine;
	...
	public class SystemPartAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SystemPart);
			}
		}
		...
		public class Adaptor : SystemPart, CrossBindingAdaptorType
		{
			...
			bool _g20;
			bool _b20;
			public override void setOnline(bool value)
			{
				if(!_g20)
				{
					_m20=instance.Type.GetMethod("setOnline",1);
					_g20=true;
				}
			...
			protected override void onlineChanged()
			{
				if(!_g21)
				{
					_m21=instance.Type.GetMethod("onlineChanged",0);
					_g21=true;
				}
			...
			bool _g22;
			bool _b22;
			public override void refreshGMType(int type)
			{
				if(!_g22)
				{
					_m22=instance.Type.GetMethod("refreshGMType",1);
					_g22=true;
				}
