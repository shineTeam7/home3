...
using ShineEngine;
	...
	public class CharacterIdentityLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(CharacterIdentityLogic);
			}
		}
		...
		public class Adaptor : CharacterIdentityLogic, CrossBindingAdaptorType
		{
