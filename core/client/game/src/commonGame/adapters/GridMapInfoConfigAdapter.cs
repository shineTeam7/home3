...
using ShineEngine;
	...
	public class GridMapInfoConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(GridMapInfoConfig);
			}
		}
		...
		public class Adaptor : GridMapInfoConfig, CrossBindingAdaptorType
		{
