...
using ShineEngine;
	...
	public class UnitModelSlotTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(UnitModelSlotTypeConfig);
			}
		}
		...
		public class Adaptor : UnitModelSlotTypeConfig, CrossBindingAdaptorType
		{
