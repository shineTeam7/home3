...
using ShineEngine;
	...
	public class GameAuctionToolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(GameAuctionToolData);
			}
		}
		...
		public class Adaptor : GameAuctionToolData, CrossBindingAdaptorType
		{
