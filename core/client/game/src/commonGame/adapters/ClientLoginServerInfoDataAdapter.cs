...
using ShineEngine;
	...
	public class ClientLoginServerInfoDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ClientLoginServerInfoData);
			}
		}
		...
		public class Adaptor : ClientLoginServerInfoData, CrossBindingAdaptorType
		{
