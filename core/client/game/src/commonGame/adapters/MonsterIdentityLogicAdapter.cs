...
using ShineEngine;
	...
	public class MonsterIdentityLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(MonsterIdentityLogic);
			}
		}
		...
		public class Adaptor : MonsterIdentityLogic, CrossBindingAdaptorType
		{
