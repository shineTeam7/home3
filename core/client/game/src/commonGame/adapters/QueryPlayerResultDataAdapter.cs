...
using ShineEngine;
	...
	public class QueryPlayerResultDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(QueryPlayerResultData);
			}
		}
		...
		public class Adaptor : QueryPlayerResultData, CrossBindingAdaptorType
		{
