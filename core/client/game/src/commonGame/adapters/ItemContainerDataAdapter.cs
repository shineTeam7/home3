...
using ShineEngine;
	...
	public class ItemContainerDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ItemContainerData);
			}
		}
		...
		public class Adaptor : ItemContainerData, CrossBindingAdaptorType
		{
