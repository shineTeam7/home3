...
using ShineEngine;
	...
	public class AreaGlobalWorkCompleteDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AreaGlobalWorkCompleteData);
			}
		}
		...
		public class Adaptor : AreaGlobalWorkCompleteData, CrossBindingAdaptorType
		{
