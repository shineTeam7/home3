...
using ShineEngine;
	...
	public class AchievementSaveDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AchievementSaveData);
			}
		}
		...
		public class Adaptor : AchievementSaveData, CrossBindingAdaptorType
		{
