...
using ShineEngine;
	...
	public class PlayerRoleGroupAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerRoleGroup);
			}
		}
		...
		public class Adaptor : PlayerRoleGroup, CrossBindingAdaptorType
		{
			...
			public override void onSecond(int delay)
			{
				if(!_g4)
				{
					_m4=instance.Type.GetMethod("onSecond",1);
					_g4=true;
				}
			...
			public override void onDaily()
			{
				if(!_g5)
				{
					_m5=instance.Type.GetMethod("onDaily",0);
					_g5=true;
				}
