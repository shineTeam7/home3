...
using ShineEngine;
	...
	public class ClientLoginExDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ClientLoginExData);
			}
		}
		...
		public class Adaptor : ClientLoginExData, CrossBindingAdaptorType
		{
