...
using ShineEngine;
	...
	public class SceneCameraFixedLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneCameraFixedLogic);
			}
		}
		...
		public class Adaptor : SceneCameraFixedLogic, CrossBindingAdaptorType
		{
