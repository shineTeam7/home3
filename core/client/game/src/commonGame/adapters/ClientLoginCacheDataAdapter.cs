...
using ShineEngine;
	...
	public class ClientLoginCacheDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ClientLoginCacheData);
			}
		}
		...
		public class Adaptor : ClientLoginCacheData, CrossBindingAdaptorType
		{
