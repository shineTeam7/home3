...
using ShineEngine;
	...
	public class RoleShowChangeDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleShowChangeData);
			}
		}
		...
		public class Adaptor : RoleShowChangeData, CrossBindingAdaptorType
		{
