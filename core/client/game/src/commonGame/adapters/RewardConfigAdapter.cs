...
using ShineEngine;
	...
	public class RewardConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RewardConfig);
			}
		}
		...
		public class Adaptor : RewardConfig, CrossBindingAdaptorType
		{
			...
			bool _g4;
			bool _b4;
			protected override void makeShowItems(SList<ItemData> list)
			{
				if(!_g4)
				{
					_m4=instance.Type.GetMethod("makeShowItems",1);
					_g4=true;
				}
