...
using ShineEngine;
	...
	public class RoleShowInfoLogDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleShowInfoLogData);
			}
		}
		...
		public class Adaptor : RoleShowInfoLogData, CrossBindingAdaptorType
		{
