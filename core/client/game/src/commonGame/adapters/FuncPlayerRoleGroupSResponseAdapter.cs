...
using ShineEngine;
	...
	public class FuncPlayerRoleGroupSResponseAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FuncPlayerRoleGroupSResponse);
			}
		}
		...
		public class Adaptor : FuncPlayerRoleGroupSResponse, CrossBindingAdaptorType
		{
			...
			public override BaseResponse readFromStream(BytesReadStream stream)
			{
				if(!_g5)
				{
					_m5=instance.Type.GetMethod("readFromStream",1);
					_g5=true;
				}
				...
				if(_m5!=null && !_b5)
				{
					_b5=true;
					_p1[0]=stream;
					BaseResponse re=(BaseResponse)appdomain.Invoke(_m5,instance,_p1);
					_p1[0]=null;
					_b5=false;
					return re;
			...
			protected override void preExecute()
			{
				if(!_g6)
				{
					_m6=instance.Type.GetMethod("preExecute",0);
					_g6=true;
				}
			...
			protected override void execute()
			{
				if(!_g7)
				{
					_m7=instance.Type.GetMethod("execute",0);
					_g7=true;
				}
			...
			protected override void toRelease(DataPool pool)
			{
				if(!_g8)
				{
					_m8=instance.Type.GetMethod("toRelease",1);
					_g8=true;
				}
