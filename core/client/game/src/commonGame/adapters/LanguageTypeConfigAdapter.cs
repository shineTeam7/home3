...
using ShineEngine;
	...
	public class LanguageTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(LanguageTypeConfig);
			}
		}
		...
		public class Adaptor : LanguageTypeConfig, CrossBindingAdaptorType
		{
