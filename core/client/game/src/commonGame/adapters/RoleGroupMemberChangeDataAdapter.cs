...
using ShineEngine;
	...
	public class RoleGroupMemberChangeDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleGroupMemberChangeData);
			}
		}
		...
		public class Adaptor : RoleGroupMemberChangeData, CrossBindingAdaptorType
		{
