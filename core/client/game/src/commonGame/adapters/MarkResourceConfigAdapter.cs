...
using ShineEngine;
	...
	public class MarkResourceConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(MarkResourceConfig);
			}
		}
		...
		public class Adaptor : MarkResourceConfig, CrossBindingAdaptorType
		{
