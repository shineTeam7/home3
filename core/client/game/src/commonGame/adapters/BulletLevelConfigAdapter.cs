...
using ShineEngine;
	...
	public class BulletLevelConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(BulletLevelConfig);
			}
		}
		...
		public class Adaptor : BulletLevelConfig, CrossBindingAdaptorType
		{
