...
using ShineEngine;
	...
	public class PlayerRoleGroupToolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerRoleGroupToolData);
			}
		}
		...
		public class Adaptor : PlayerRoleGroupToolData, CrossBindingAdaptorType
		{
