...
using ShineEngine;
	...
	public class RoleSocialPoolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleSocialPoolData);
			}
		}
		...
		public class Adaptor : RoleSocialPoolData, CrossBindingAdaptorType
		{
