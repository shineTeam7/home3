...
using ShineEngine;
	...
	public class SkillStepLevelConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SkillStepLevelConfig);
			}
		}
		...
		public class Adaptor : SkillStepLevelConfig, CrossBindingAdaptorType
		{
