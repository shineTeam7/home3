...
using ShineEngine;
	...
	public class SceneCameraLogic3DOneAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneCameraLogic3DOne);
			}
		}
		...
		public class Adaptor : SceneCameraLogic3DOne, CrossBindingAdaptorType
		{
