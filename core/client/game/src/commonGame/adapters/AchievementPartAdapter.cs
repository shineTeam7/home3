...
using ShineEngine;
	...
	public class AchievementPartAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AchievementPart);
			}
		}
		...
		public class Adaptor : AchievementPart, CrossBindingAdaptorType
		{
			...
			bool _g20;
			bool _b20;
			protected override void onAchievementComplete(int id)
			{
				if(!_g20)
				{
					_m20=instance.Type.GetMethod("onAchievementComplete",1);
					_g20=true;
				}
