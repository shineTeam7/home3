...
using ShineEngine;
	...
	public class RoleGroupChangeDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleGroupChangeData);
			}
		}
		...
		public class Adaptor : RoleGroupChangeData, CrossBindingAdaptorType
		{
