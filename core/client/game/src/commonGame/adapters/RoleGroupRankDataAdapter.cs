...
using ShineEngine;
	...
	public class RoleGroupRankDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleGroupRankData);
			}
		}
		...
		public class Adaptor : RoleGroupRankData, CrossBindingAdaptorType
		{
