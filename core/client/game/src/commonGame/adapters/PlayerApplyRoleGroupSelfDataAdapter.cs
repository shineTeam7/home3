...
using ShineEngine;
	...
	public class PlayerApplyRoleGroupSelfDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerApplyRoleGroupSelfData);
			}
		}
		...
		public class Adaptor : PlayerApplyRoleGroupSelfData, CrossBindingAdaptorType
		{
