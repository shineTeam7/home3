...
using ShineEngine;
	...
	public class PreBattleScenePlayLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PreBattleScenePlayLogic);
			}
		}
		...
		public class Adaptor : PreBattleScenePlayLogic, CrossBindingAdaptorType
		{
