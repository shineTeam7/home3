...
using ShineEngine;
	...
	public class MUnitIdentityDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(MUnitIdentityData);
			}
		}
		...
		public class Adaptor : MUnitIdentityData, CrossBindingAdaptorType
		{
