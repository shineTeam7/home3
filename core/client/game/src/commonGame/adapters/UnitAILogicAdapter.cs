...
using ShineEngine;
	...
	public class UnitAILogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(UnitAILogic);
			}
		}
		...
		public class Adaptor : UnitAILogic, CrossBindingAdaptorType
		{
			...
			bool _g11;
			bool _b11;
			protected override SkillData toSelectPursueSkill()
			{
				if(!_g11)
				{
					_m11=instance.Type.GetMethod("toSelectPursueSkill",0);
					_g11=true;
				}
				...
				{
					_b11=true;
					SkillData re=(SkillData)appdomain.Invoke(_m11,instance,null);
					_b11=false;
					return re;
				...
				{
					return base.toSelectPursueSkill();
				}
			}
