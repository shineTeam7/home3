...
using ShineEngine;
	...
	public class QuestCompleteDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(QuestCompleteData);
			}
		}
		...
		public class Adaptor : QuestCompleteData, CrossBindingAdaptorType
		{
