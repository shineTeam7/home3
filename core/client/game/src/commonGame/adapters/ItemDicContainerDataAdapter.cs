...
using ShineEngine;
	...
	public class ItemDicContainerDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ItemDicContainerData);
			}
		}
		...
		public class Adaptor : ItemDicContainerData, CrossBindingAdaptorType
		{
