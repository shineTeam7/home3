...
using ShineEngine;
	...
	public class PlayerRankToolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerRankToolData);
			}
		}
		...
		public class Adaptor : PlayerRankToolData, CrossBindingAdaptorType
		{
