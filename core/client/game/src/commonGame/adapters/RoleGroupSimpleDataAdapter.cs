...
using ShineEngine;
	...
	public class RoleGroupSimpleDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleGroupSimpleData);
			}
		}
		...
		public class Adaptor : RoleGroupSimpleData, CrossBindingAdaptorType
		{
