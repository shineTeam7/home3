...
using ShineEngine;
	...
	public class AuctionItemRecordDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AuctionItemRecordData);
			}
		}
		...
		public class Adaptor : AuctionItemRecordData, CrossBindingAdaptorType
		{
