...
using ShineEngine;
	...
	public class SingleCharacterPartAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SingleCharacterPart);
			}
		}
		...
		public class Adaptor : SingleCharacterPart, CrossBindingAdaptorType
		{
