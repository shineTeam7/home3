...
using ShineEngine;
	...
	public class CountryCodeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(CountryCodeConfig);
			}
		}
		...
		public class Adaptor : CountryCodeConfig, CrossBindingAdaptorType
		{
