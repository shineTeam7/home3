...
using ShineEngine;
	...
	public class CharacterUseDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(CharacterUseData);
			}
		}
		...
		public class Adaptor : CharacterUseData, CrossBindingAdaptorType
		{
			...
			public override int getFightUnitID()
			{
				if(!_g15)
				{
					_m15=instance.Type.GetMethod("getFightUnitID",0);
					_g15=true;
				}
				...
				{
					_b15=true;
					int re=(int)appdomain.Invoke(_m15,instance,null);
					_b15=false;
					return re;
			...
			public override int getUnitType()
			{
				if(!_g16)
				{
					_m16=instance.Type.GetMethod("getUnitType",0);
					_g16=true;
				}
				...
				{
					_b16=true;
					int re=(int)appdomain.Invoke(_m16,instance,null);
					_b16=false;
					return re;
