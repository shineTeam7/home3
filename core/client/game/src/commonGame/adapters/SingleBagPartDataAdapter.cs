...
using ShineEngine;
	...
	public class SingleBagPartDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SingleBagPartData);
			}
		}
		...
		public class Adaptor : SingleBagPartData, CrossBindingAdaptorType
		{
