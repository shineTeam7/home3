...
using ShineEngine;
	...
	public class PlayerRoleGroupClientToolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerRoleGroupClientToolData);
			}
		}
		...
		public class Adaptor : PlayerRoleGroupClientToolData, CrossBindingAdaptorType
		{
