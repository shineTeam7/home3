...
using ShineEngine;
	...
	public class ServerSimpleInfoDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ServerSimpleInfoData);
			}
		}
		...
		public class Adaptor : ServerSimpleInfoData, CrossBindingAdaptorType
		{
