...
using ShineEngine;
	...
	public class RefreshCurrentLineResponseAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RefreshCurrentLineResponse);
			}
		}
		...
		public class Adaptor : RefreshCurrentLineResponse, CrossBindingAdaptorType
		{
