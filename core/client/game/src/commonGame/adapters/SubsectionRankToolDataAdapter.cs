...
using ShineEngine;
	...
	public class SubsectionRankToolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SubsectionRankToolData);
			}
		}
		...
		public class Adaptor : SubsectionRankToolData, CrossBindingAdaptorType
		{
