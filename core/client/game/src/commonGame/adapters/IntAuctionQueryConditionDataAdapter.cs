...
using ShineEngine;
	...
	public class IntAuctionQueryConditionDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(IntAuctionQueryConditionData);
			}
		}
		...
		public class Adaptor : IntAuctionQueryConditionData, CrossBindingAdaptorType
		{
