...
using ShineEngine;
	...
	public class CharacterControlLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(CharacterControlLogic);
			}
		}
		...
		public class Adaptor : CharacterControlLogic, CrossBindingAdaptorType
		{
