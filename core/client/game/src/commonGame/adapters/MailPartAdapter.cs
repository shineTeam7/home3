...
using ShineEngine;
	...
	public class MailPartAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(MailPart);
			}
		}
		...
		public class Adaptor : MailPart, CrossBindingAdaptorType
		{
			...
			bool _g20;
			bool _b20;
			public override void onAddMailForG(MailData data)
			{
				if(!_g20)
				{
					_m20=instance.Type.GetMethod("onAddMailForG",1);
					_g20=true;
				}
