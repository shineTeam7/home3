...
using ShineEngine;
	...
	public class CreateRoleGroupDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(CreateRoleGroupData);
			}
		}
		...
		public class Adaptor : CreateRoleGroupData, CrossBindingAdaptorType
		{
