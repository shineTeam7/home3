...
using ShineEngine;
	...
	public class BigFloatRankConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(BigFloatRankConfig);
			}
		}
		...
		public class Adaptor : BigFloatRankConfig, CrossBindingAdaptorType
		{
