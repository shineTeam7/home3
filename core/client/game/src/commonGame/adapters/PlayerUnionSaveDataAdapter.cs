...
using ShineEngine;
	...
	public class PlayerUnionSaveDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerUnionSaveData);
			}
		}
		...
		public class Adaptor : PlayerUnionSaveData, CrossBindingAdaptorType
		{
