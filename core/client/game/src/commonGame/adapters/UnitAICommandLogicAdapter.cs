...
using ShineEngine;
	...
	public class UnitAICommandLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(UnitAICommandLogic);
			}
		}
		...
		public class Adaptor : UnitAICommandLogic, CrossBindingAdaptorType
		{
			...
			bool _g11;
			bool _b11;
			protected override void doPickUp(Unit unit)
			{
				if(!_g11)
				{
					_m11=instance.Type.GetMethod("doPickUp",1);
					_g11=true;
				}
