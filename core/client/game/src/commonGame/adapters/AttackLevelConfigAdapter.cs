...
using ShineEngine;
	...
	public class AttackLevelConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AttackLevelConfig);
			}
		}
		...
		public class Adaptor : AttackLevelConfig, CrossBindingAdaptorType
		{
