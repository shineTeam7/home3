...
using ShineEngine;
	...
	public class QuestPartAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(QuestPart);
			}
		}
		...
		public class Adaptor : QuestPart, CrossBindingAdaptorType
		{
			...
			bool _g20;
			bool _b20;
			protected override TaskData toCreateTaskData(int type)
			{
				if(!_g20)
				{
					_m20=instance.Type.GetMethod("toCreateTaskData",1);
					_g20=true;
				}
				...
				if(_m20!=null && !_b20)
				{
					_b20=true;
					_p1[0]=type;
					TaskData re=(TaskData)appdomain.Invoke(_m20,instance,_p1);
					_p1[0]=null;
					_b20=false;
					return re;
				...
				{
					return base.toCreateTaskData(type);
				}
			}
			...
			bool _g21;
			bool _b21;
			protected override bool checkOneSeeCondition(int[] args)
			{
				if(!_g21)
				{
					_m21=instance.Type.GetMethod("checkOneSeeCondition",1);
					_g21=true;
				}
				...
				{
					return base.checkOneSeeCondition(args);
				}
			}
			...
			bool _g22;
			bool _b22;
			protected override void refreshTaskData(TaskData data)
			{
				if(!_g22)
				{
					_m22=instance.Type.GetMethod("refreshTaskData",1);
					_g22=true;
				}
			...
			bool _g23;
			bool _b23;
			protected override void toTaskEvent(TaskData data,int[] vars)
			{
				if(!_g23)
				{
					_m23=instance.Type.GetMethod("toTaskEvent",2);
					_g23=true;
				}
