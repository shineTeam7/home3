...
using ShineEngine;
	...
	public class AuctionQueryConditionDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AuctionQueryConditionData);
			}
		}
		...
		public class Adaptor : AuctionQueryConditionData, CrossBindingAdaptorType
		{
