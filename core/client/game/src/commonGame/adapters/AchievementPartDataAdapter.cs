...
using ShineEngine;
	...
	public class AchievementPartDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AchievementPartData);
			}
		}
		...
		public class Adaptor : AchievementPartData, CrossBindingAdaptorType
		{
