...
using ShineEngine;
	...
	public class UnitMoveTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(UnitMoveTypeConfig);
			}
		}
		...
		public class Adaptor : UnitMoveTypeConfig, CrossBindingAdaptorType
		{
