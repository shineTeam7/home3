...
using ShineEngine;
	...
	public class ClientOfflineWorkListDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ClientOfflineWorkListData);
			}
		}
		...
		public class Adaptor : ClientOfflineWorkListData, CrossBindingAdaptorType
		{
