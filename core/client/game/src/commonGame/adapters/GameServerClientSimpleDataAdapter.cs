...
using ShineEngine;
	...
	public class GameServerClientSimpleDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(GameServerClientSimpleData);
			}
		}
		...
		public class Adaptor : GameServerClientSimpleData, CrossBindingAdaptorType
		{
