...
using ShineEngine;
	...
	public class ClientPlatformTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ClientPlatformTypeConfig);
			}
		}
		...
		public class Adaptor : ClientPlatformTypeConfig, CrossBindingAdaptorType
		{
