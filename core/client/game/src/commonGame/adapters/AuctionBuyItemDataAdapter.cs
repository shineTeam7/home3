...
using ShineEngine;
	...
	public class AuctionBuyItemDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AuctionBuyItemData);
			}
		}
		...
		public class Adaptor : AuctionBuyItemData, CrossBindingAdaptorType
		{
