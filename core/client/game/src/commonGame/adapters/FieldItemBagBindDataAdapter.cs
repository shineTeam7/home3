...
using ShineEngine;
	...
	public class FieldItemBagBindDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FieldItemBagBindData);
			}
		}
		...
		public class Adaptor : FieldItemBagBindData, CrossBindingAdaptorType
		{
