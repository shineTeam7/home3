...
using ShineEngine;
	...
	public class InviteRoleGroupReceiveDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(InviteRoleGroupReceiveData);
			}
		}
		...
		public class Adaptor : InviteRoleGroupReceiveData, CrossBindingAdaptorType
		{
