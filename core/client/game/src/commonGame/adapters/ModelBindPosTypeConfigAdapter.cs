...
using ShineEngine;
	...
	public class ModelBindPosTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ModelBindPosTypeConfig);
			}
		}
		...
		public class Adaptor : ModelBindPosTypeConfig, CrossBindingAdaptorType
		{
