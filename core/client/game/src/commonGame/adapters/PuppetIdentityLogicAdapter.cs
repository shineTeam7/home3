...
using ShineEngine;
	...
	public class PuppetIdentityLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PuppetIdentityLogic);
			}
		}
		...
		public class Adaptor : PuppetIdentityLogic, CrossBindingAdaptorType
		{
			...
			protected override void initAI()
			{
				if(!_g11)
				{
					_m11=instance.Type.GetMethod("initAI",0);
					_g11=true;
				}
