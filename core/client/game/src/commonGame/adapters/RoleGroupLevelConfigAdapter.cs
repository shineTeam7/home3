...
using ShineEngine;
	...
	public class RoleGroupLevelConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleGroupLevelConfig);
			}
		}
		...
		public class Adaptor : RoleGroupLevelConfig, CrossBindingAdaptorType
		{
