...
using ShineEngine;
	...
	public class SubsectionRankSimpleDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SubsectionRankSimpleData);
			}
		}
		...
		public class Adaptor : SubsectionRankSimpleData, CrossBindingAdaptorType
		{
