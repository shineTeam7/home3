...
using ShineEngine;
	...
	public class ClientVersionDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ClientVersionData);
			}
		}
		...
		public class Adaptor : ClientVersionData, CrossBindingAdaptorType
		{
