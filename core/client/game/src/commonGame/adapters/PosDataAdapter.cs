...
using ShineEngine;
	...
	public class PosDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PosData);
			}
		}
		...
		public class Adaptor : PosData, CrossBindingAdaptorType
		{
			...
			bool _g15;
			bool _b15;
			public override void setByFArr(float[] arr)
			{
				if(!_g15)
				{
					_m15=instance.Type.GetMethod("setByFArr",1);
					_g15=true;
				}
			...
			bool _g16;
			bool _b16;
			public override void setByIArr(int[] arr)
			{
				if(!_g16)
				{
					_m16=instance.Type.GetMethod("setByIArr",1);
					_g16=true;
				}
			...
			bool _g17;
			bool _b17;
			public override void writeFArr(float[] arr)
			{
				if(!_g17)
				{
					_m17=instance.Type.GetMethod("writeFArr",1);
					_g17=true;
				}
