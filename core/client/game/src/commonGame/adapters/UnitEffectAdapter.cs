...
using ShineEngine;
	...
	public class UnitEffectAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(UnitEffect);
			}
		}
		...
		public class Adaptor : UnitEffect, CrossBindingAdaptorType
		{
			...
			bool _g4;
			bool _b4;
			protected override void onLoadOver(GameObject obj)
			{
				if(!_g4)
				{
					_m4=instance.Type.GetMethod("onLoadOver",1);
					_g4=true;
				}
			...
			protected override void afterLoadOver()
			{
				if(!_g5)
				{
					_m5=instance.Type.GetMethod("afterLoadOver",0);
					_g5=true;
				}
			...
			public override void onSetPos(PosData pos)
			{
				if(!_g6)
				{
					_m6=instance.Type.GetMethod("onSetPos",1);
					_g6=true;
				}
			...
			public override void onSetDir(DirData dir)
			{
				if(!_g7)
				{
					_m7=instance.Type.GetMethod("onSetDir",1);
					_g7=true;
				}
