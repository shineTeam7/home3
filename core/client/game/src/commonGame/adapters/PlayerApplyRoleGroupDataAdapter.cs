...
using ShineEngine;
	...
	public class PlayerApplyRoleGroupDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerApplyRoleGroupData);
			}
		}
		...
		public class Adaptor : PlayerApplyRoleGroupData, CrossBindingAdaptorType
		{
