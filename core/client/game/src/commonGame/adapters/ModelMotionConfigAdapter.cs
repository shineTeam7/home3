...
using ShineEngine;
	...
	public class ModelMotionConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ModelMotionConfig);
			}
		}
		...
		public class Adaptor : ModelMotionConfig, CrossBindingAdaptorType
		{
