...
using ShineEngine;
	...
	public class UnitAvatarLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(UnitAvatarLogic);
			}
		}
		...
		public class Adaptor : UnitAvatarLogic, CrossBindingAdaptorType
		{
			...
			bool _g11;
			bool _b11;
			protected override void onRefreshModel(int modelID)
			{
				if(!_g11)
				{
					_m11=instance.Type.GetMethod("onRefreshModel",1);
					_g11=true;
				}
