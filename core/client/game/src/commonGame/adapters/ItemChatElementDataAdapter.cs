...
using ShineEngine;
	...
	public class ItemChatElementDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ItemChatElementData);
			}
		}
		...
		public class Adaptor : ItemChatElementData, CrossBindingAdaptorType
		{
