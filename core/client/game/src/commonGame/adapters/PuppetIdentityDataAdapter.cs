...
using ShineEngine;
	...
	public class PuppetIdentityDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PuppetIdentityData);
			}
		}
		...
		public class Adaptor : PuppetIdentityData, CrossBindingAdaptorType
		{
