...
using ShineEngine;
	...
	public class RoleAttributeDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleAttributeData);
			}
		}
		...
		public class Adaptor : RoleAttributeData, CrossBindingAdaptorType
		{
