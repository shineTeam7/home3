...
using ShineEngine;
	...
	public class EquipContainerDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(EquipContainerData);
			}
		}
		...
		public class Adaptor : EquipContainerData, CrossBindingAdaptorType
		{
