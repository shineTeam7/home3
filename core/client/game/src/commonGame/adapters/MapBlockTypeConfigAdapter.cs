...
using ShineEngine;
	...
	public class MapBlockTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(MapBlockTypeConfig);
			}
		}
		...
		public class Adaptor : MapBlockTypeConfig, CrossBindingAdaptorType
		{
