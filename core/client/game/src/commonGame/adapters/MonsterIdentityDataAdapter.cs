...
using ShineEngine;
	...
	public class MonsterIdentityDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(MonsterIdentityData);
			}
		}
		...
		public class Adaptor : MonsterIdentityData, CrossBindingAdaptorType
		{
