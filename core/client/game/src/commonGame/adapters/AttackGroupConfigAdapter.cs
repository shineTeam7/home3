...
using ShineEngine;
	...
	public class AttackGroupConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AttackGroupConfig);
			}
		}
		...
		public class Adaptor : AttackGroupConfig, CrossBindingAdaptorType
		{
