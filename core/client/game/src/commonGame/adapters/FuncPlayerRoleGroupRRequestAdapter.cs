...
using ShineEngine;
	...
	public class FuncPlayerRoleGroupRRequestAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FuncPlayerRoleGroupRRequest);
			}
		}
		...
		public class Adaptor : FuncPlayerRoleGroupRRequest, CrossBindingAdaptorType
		{
