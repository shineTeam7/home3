...
using ShineEngine;
	...
	public class LoginHttpRequestAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(LoginHttpRequest);
			}
		}
		...
		public class Adaptor : LoginHttpRequest, CrossBindingAdaptorType
		{
			...
			protected override void copyData()
			{
				if(!_g15)
				{
					_m15=instance.Type.GetMethod("copyData",0);
					_g15=true;
				}
			...
			protected override void write()
			{
				if(!_g16)
				{
					_m16=instance.Type.GetMethod("write",0);
					_g16=true;
				}
			...
			protected override void read()
			{
				if(!_g17)
				{
					_m17=instance.Type.GetMethod("read",0);
					_g17=true;
				}
			...
			protected override void onError()
			{
				if(!_g18)
				{
					_m18=instance.Type.GetMethod("onError",0);
					_g18=true;
				}
			...
			protected override void onComplete()
			{
				if(!_g19)
				{
					_m19=instance.Type.GetMethod("onComplete",0);
					_g19=true;
				}
			...
			protected override void toRead()
			{
				if(!_g20)
				{
					_m20=instance.Type.GetMethod("toRead",0);
					_g20=true;
				}
			...
			bool _g21;
			bool _b21;
			protected override void doSendSync()
			{
				if(!_g21)
				{
					_m21=instance.Type.GetMethod("doSendSync",0);
					_g21=true;
				}
