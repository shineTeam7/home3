...
using ShineEngine;
	...
	public class RoleSocialPoolToolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleSocialPoolToolData);
			}
		}
		...
		public class Adaptor : RoleSocialPoolToolData, CrossBindingAdaptorType
		{
