...
using ShineEngine;
	...
	public class SingleCharacterPartDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SingleCharacterPartData);
			}
		}
		...
		public class Adaptor : SingleCharacterPartData, CrossBindingAdaptorType
		{
