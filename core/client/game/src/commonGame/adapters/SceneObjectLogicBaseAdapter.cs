...
using ShineEngine;
	...
	public class SceneObjectLogicBaseAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneObjectLogicBase);
			}
		}
		...
		public class Adaptor : SceneObjectLogicBase, CrossBindingAdaptorType
		{
