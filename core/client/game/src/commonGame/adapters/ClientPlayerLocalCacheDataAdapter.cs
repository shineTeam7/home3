...
using ShineEngine;
	...
	public class ClientPlayerLocalCacheDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ClientPlayerLocalCacheData);
			}
		}
		...
		public class Adaptor : ClientPlayerLocalCacheData, CrossBindingAdaptorType
		{
