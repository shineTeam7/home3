...
using ShineEngine;
	...
	public class AuctionSoldLogDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AuctionSoldLogData);
			}
		}
		...
		public class Adaptor : AuctionSoldLogData, CrossBindingAdaptorType
		{
