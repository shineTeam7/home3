...
using ShineEngine;
	...
	public class SceneEffectConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneEffectConfig);
			}
		}
		...
		public class Adaptor : SceneEffectConfig, CrossBindingAdaptorType
		{
