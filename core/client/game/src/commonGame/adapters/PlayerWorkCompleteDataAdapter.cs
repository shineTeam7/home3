...
using ShineEngine;
	...
	public class PlayerWorkCompleteDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerWorkCompleteData);
			}
		}
		...
		public class Adaptor : PlayerWorkCompleteData, CrossBindingAdaptorType
		{
