...
using ShineEngine;
	...
	public class ChatChannelConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ChatChannelConfig);
			}
		}
		...
		public class Adaptor : ChatChannelConfig, CrossBindingAdaptorType
		{
