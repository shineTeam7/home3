...
using ShineEngine;
	...
	public class RoleGroupCreateSceneDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleGroupCreateSceneData);
			}
		}
		...
		public class Adaptor : RoleGroupCreateSceneData, CrossBindingAdaptorType
		{
