...
using ShineEngine;
	...
	public class SkillInfluenceTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SkillInfluenceTypeConfig);
			}
		}
		...
		public class Adaptor : SkillInfluenceTypeConfig, CrossBindingAdaptorType
		{
