...
using ShineEngine;
	...
	public class VehicleIdentityLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(VehicleIdentityLogic);
			}
		}
		...
		public class Adaptor : VehicleIdentityLogic, CrossBindingAdaptorType
		{
