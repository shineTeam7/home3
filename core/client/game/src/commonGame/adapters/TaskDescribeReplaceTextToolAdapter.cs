...
using ShineEngine;
	...
	public class TaskDescribeReplaceTextToolAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(TaskDescribeReplaceTextTool);
			}
		}
		...
		public class Adaptor : TaskDescribeReplaceTextTool, CrossBindingAdaptorType
		{
