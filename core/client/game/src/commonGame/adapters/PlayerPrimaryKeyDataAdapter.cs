...
using ShineEngine;
	...
	public class PlayerPrimaryKeyDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerPrimaryKeyData);
			}
		}
		...
		public class Adaptor : PlayerPrimaryKeyData, CrossBindingAdaptorType
		{
