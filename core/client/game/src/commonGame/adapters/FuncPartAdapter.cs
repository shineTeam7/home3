...
using ShineEngine;
	...
	public class FuncPartAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FuncPart);
			}
		}
		...
		public class Adaptor : FuncPart, CrossBindingAdaptorType
		{
			...
			bool _g20;
			bool _b20;
			protected override bool checkOneFuncCondition(int[] args)
			{
				if(!_g20)
				{
					_m20=instance.Type.GetMethod("checkOneFuncCondition",1);
					_g20=true;
				}
				...
				{
					return base.checkOneFuncCondition(args);
				}
			}
