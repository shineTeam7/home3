...
using ShineEngine;
	...
	public class ExchangeGroupConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ExchangeGroupConfig);
			}
		}
		...
		public class Adaptor : ExchangeGroupConfig, CrossBindingAdaptorType
		{
