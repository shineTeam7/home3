...
using ShineEngine;
	...
	public class RandomItemListConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RandomItemListConfig);
			}
		}
		...
		public class Adaptor : RandomItemListConfig, CrossBindingAdaptorType
		{
