...
using ShineEngine;
	...
	public class SubsectionRankConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SubsectionRankConfig);
			}
		}
		...
		public class Adaptor : SubsectionRankConfig, CrossBindingAdaptorType
		{
