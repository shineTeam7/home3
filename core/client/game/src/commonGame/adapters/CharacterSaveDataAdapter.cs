...
using ShineEngine;
	...
	public class CharacterSaveDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(CharacterSaveData);
			}
		}
		...
		public class Adaptor : CharacterSaveData, CrossBindingAdaptorType
		{
