...
using ShineEngine;
	...
	public class RoleGroupToolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleGroupToolData);
			}
		}
		...
		public class Adaptor : RoleGroupToolData, CrossBindingAdaptorType
		{
