...
using ShineEngine;
	...
	public class FrameSyncCommandDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FrameSyncCommandData);
			}
		}
		...
		public class Adaptor : FrameSyncCommandData, CrossBindingAdaptorType
		{
