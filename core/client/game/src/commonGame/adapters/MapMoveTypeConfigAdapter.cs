...
using ShineEngine;
	...
	public class MapMoveTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(MapMoveTypeConfig);
			}
		}
		...
		public class Adaptor : MapMoveTypeConfig, CrossBindingAdaptorType
		{
