...
using ShineEngine;
	...
	public class MonsterLevelConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(MonsterLevelConfig);
			}
		}
		...
		public class Adaptor : MonsterLevelConfig, CrossBindingAdaptorType
		{
