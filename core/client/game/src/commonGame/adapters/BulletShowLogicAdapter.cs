...
using ShineEngine;
	...
	public class BulletShowLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(BulletShowLogic);
			}
		}
		...
		public class Adaptor : BulletShowLogic, CrossBindingAdaptorType
		{
			...
			public override void effectLoadOver()
			{
				if(!_g10)
				{
					_m10=instance.Type.GetMethod("effectLoadOver",0);
					_g10=true;
				}
			...
			bool _g11;
			bool _b11;
			public override void effectPlayOver()
			{
				if(!_g11)
				{
					_m11=instance.Type.GetMethod("effectPlayOver",0);
					_g11=true;
				}
