...
using ShineEngine;
	...
	public class AuctionQueryConditionTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AuctionQueryConditionTypeConfig);
			}
		}
		...
		public class Adaptor : AuctionQueryConditionTypeConfig, CrossBindingAdaptorType
		{
