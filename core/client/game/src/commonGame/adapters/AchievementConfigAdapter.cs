...
using ShineEngine;
	...
	public class AchievementConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AchievementConfig);
			}
		}
		...
		public class Adaptor : AchievementConfig, CrossBindingAdaptorType
		{
