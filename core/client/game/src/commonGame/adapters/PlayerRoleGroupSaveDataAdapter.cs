...
using ShineEngine;
	...
	public class PlayerRoleGroupSaveDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerRoleGroupSaveData);
			}
		}
		...
		public class Adaptor : PlayerRoleGroupSaveData, CrossBindingAdaptorType
		{
