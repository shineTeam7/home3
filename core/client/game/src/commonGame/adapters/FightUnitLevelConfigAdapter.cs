...
using ShineEngine;
	...
	public class FightUnitLevelConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FightUnitLevelConfig);
			}
		}
		...
		public class Adaptor : FightUnitLevelConfig, CrossBindingAdaptorType
		{
