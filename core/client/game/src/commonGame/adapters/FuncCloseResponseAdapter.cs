...
using ShineEngine;
	...
	public class FuncCloseResponseAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FuncCloseResponse);
			}
		}
		...
		public class Adaptor : FuncCloseResponse, CrossBindingAdaptorType
		{
