...
using ShineEngine;
	...
	public class RoleAttributeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleAttributeConfig);
			}
		}
		...
		public class Adaptor : RoleAttributeConfig, CrossBindingAdaptorType
		{
