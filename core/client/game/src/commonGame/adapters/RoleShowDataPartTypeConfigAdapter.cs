...
using ShineEngine;
	...
	public class RoleShowDataPartTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleShowDataPartTypeConfig);
			}
		}
		...
		public class Adaptor : RoleShowDataPartTypeConfig, CrossBindingAdaptorType
		{
