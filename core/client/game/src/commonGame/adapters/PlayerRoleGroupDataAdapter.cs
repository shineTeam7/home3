...
using ShineEngine;
	...
	public class PlayerRoleGroupDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerRoleGroupData);
			}
		}
		...
		public class Adaptor : PlayerRoleGroupData, CrossBindingAdaptorType
		{
