...
using ShineEngine;
	...
	public class SceneUnitFactoryLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneUnitFactoryLogic);
			}
		}
		...
		public class Adaptor : SceneUnitFactoryLogic, CrossBindingAdaptorType
		{
