...
using ShineEngine;
	...
	public class CenterRoleGroupToolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(CenterRoleGroupToolData);
			}
		}
		...
		public class Adaptor : CenterRoleGroupToolData, CrossBindingAdaptorType
		{
