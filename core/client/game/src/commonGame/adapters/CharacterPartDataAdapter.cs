...
using ShineEngine;
	...
	public class CharacterPartDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(CharacterPartData);
			}
		}
		...
		public class Adaptor : CharacterPartData, CrossBindingAdaptorType
		{
