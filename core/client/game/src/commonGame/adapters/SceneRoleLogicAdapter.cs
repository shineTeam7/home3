...
using ShineEngine;
	...
	public class SceneRoleLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneRoleLogic);
			}
		}
		...
		public class Adaptor : SceneRoleLogic, CrossBindingAdaptorType
		{
			...
			bool _g11;
			bool _b11;
			protected override void onAddRole(Role role)
			{
				if(!_g11)
				{
					_m11=instance.Type.GetMethod("onAddRole",1);
					_g11=true;
				}
			...
			bool _g12;
			bool _b12;
			protected override void onRemoveRole(Role role)
			{
				if(!_g12)
				{
					_m12=instance.Type.GetMethod("onRemoveRole",1);
					_g12=true;
				}
			...
			bool _g13;
			bool _b13;
			protected override void onAddFieldItemBagBind(FieldItemBagBindData data)
			{
				if(!_g13)
				{
					_m13=instance.Type.GetMethod("onAddFieldItemBagBind",1);
					_g13=true;
				}
				...
				{
					base.onAddFieldItemBagBind(data);
				}
			}
