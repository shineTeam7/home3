...
using ShineEngine;
	...
	public class SensitiveWordConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SensitiveWordConfig);
			}
		}
		...
		public class Adaptor : SensitiveWordConfig, CrossBindingAdaptorType
		{
