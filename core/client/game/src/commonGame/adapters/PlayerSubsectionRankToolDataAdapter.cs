...
using ShineEngine;
	...
	public class PlayerSubsectionRankToolDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PlayerSubsectionRankToolData);
			}
		}
		...
		public class Adaptor : PlayerSubsectionRankToolData, CrossBindingAdaptorType
		{
