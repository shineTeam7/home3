...
using ShineEngine;
	...
	public class BuildingLevelConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(BuildingLevelConfig);
			}
		}
		...
		public class Adaptor : BuildingLevelConfig, CrossBindingAdaptorType
		{
