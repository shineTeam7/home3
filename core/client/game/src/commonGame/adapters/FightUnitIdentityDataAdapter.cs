...
using ShineEngine;
	...
	public class FightUnitIdentityDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FightUnitIdentityData);
			}
		}
		...
		public class Adaptor : FightUnitIdentityData, CrossBindingAdaptorType
		{
