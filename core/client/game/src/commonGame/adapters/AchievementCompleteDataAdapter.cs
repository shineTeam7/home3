...
using ShineEngine;
	...
	public class AchievementCompleteDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(AchievementCompleteData);
			}
		}
		...
		public class Adaptor : AchievementCompleteData, CrossBindingAdaptorType
		{
