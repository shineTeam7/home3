...
using ShineEngine;
	...
	public class RoleSimpleShowDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleSimpleShowData);
			}
		}
		...
		public class Adaptor : RoleSimpleShowData, CrossBindingAdaptorType
		{
