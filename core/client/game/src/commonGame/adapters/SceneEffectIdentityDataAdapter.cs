...
using ShineEngine;
	...
	public class SceneEffectIdentityDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneEffectIdentityData);
			}
		}
		...
		public class Adaptor : SceneEffectIdentityData, CrossBindingAdaptorType
		{
