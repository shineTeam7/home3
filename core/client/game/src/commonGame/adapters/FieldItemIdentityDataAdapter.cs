...
using ShineEngine;
	...
	public class FieldItemIdentityDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(FieldItemIdentityData);
			}
		}
		...
		public class Adaptor : FieldItemIdentityData, CrossBindingAdaptorType
		{
