...
using ShineEngine;
	...
	public class SceneLoadLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneLoadLogic);
			}
		}
		...
		public class Adaptor : SceneLoadLogic, CrossBindingAdaptorType
		{
			...
			bool _g11;
			bool _b11;
			protected override void doLoadOne()
			{
				if(!_g11)
				{
					_m11=instance.Type.GetMethod("doLoadOne",0);
					_g11=true;
				}
			...
			bool _g12;
			bool _b12;
			protected override void makeListEx()
			{
				if(!_g12)
				{
					_m12=instance.Type.GetMethod("makeListEx",0);
					_g12=true;
				}
			...
			bool _g13;
			bool _b13;
			protected override void onLoadOneOver()
			{
				if(!_g13)
				{
					_m13=instance.Type.GetMethod("onLoadOneOver",0);
					_g13=true;
				}
			...
			bool _g14;
			bool _b14;
			protected override string getSceneUseName()
			{
				if(!_g14)
				{
					_m14=instance.Type.GetMethod("getSceneUseName",0);
					_g14=true;
				}
				...
				{
					_b14=true;
					string re=(string)appdomain.Invoke(_m14,instance,null);
					_b14=false;
					return re;
			...
			bool _g15;
			bool _b15;
			protected override void makeUnitLoadList(IntSet loadList,UnitInfoData data)
			{
				if(!_g15)
				{
					_m15=instance.Type.GetMethod("makeUnitLoadList",2);
					_g15=true;
				}
				...
				{
					base.makeUnitLoadList(loadList,data);
				}
			}
