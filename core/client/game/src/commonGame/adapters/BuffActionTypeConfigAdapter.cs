...
using ShineEngine;
	...
	public class BuffActionTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(BuffActionTypeConfig);
			}
		}
		...
		public class Adaptor : BuffActionTypeConfig, CrossBindingAdaptorType
		{
