...
using ShineEngine;
	...
	public class ApplyAddFriendDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ApplyAddFriendData);
			}
		}
		...
		public class Adaptor : ApplyAddFriendData, CrossBindingAdaptorType
		{
