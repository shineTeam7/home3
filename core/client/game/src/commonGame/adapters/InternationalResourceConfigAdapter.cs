...
using ShineEngine;
	...
	public class InternationalResourceConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(InternationalResourceConfig);
			}
		}
		...
		public class Adaptor : InternationalResourceConfig, CrossBindingAdaptorType
		{
			...
			bool _g4;
			bool _b4;
			protected override string getStr(int type)
			{
				if(!_g4)
				{
					_m4=instance.Type.GetMethod("getStr",1);
					_g4=true;
				}
				...
				if(_m4!=null && !_b4)
				{
					_b4=true;
					_p1[0]=type;
					string re=(string)appdomain.Invoke(_m4,instance,_p1);
					_p1[0]=null;
					_b4=false;
					return re;
			...
			protected override void toWriteBytesSimple(BytesWriteStream stream)
			{
				if(!_g5)
				{
					_m5=instance.Type.GetMethod("toWriteBytesSimple",1);
					_g5=true;
				}
