...
using ShineEngine;
	...
	public class GameServerSimpleInfoDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(GameServerSimpleInfoData);
			}
		}
		...
		public class Adaptor : GameServerSimpleInfoData, CrossBindingAdaptorType
		{
