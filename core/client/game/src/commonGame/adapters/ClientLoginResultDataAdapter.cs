...
using ShineEngine;
	...
	public class ClientLoginResultDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(ClientLoginResultData);
			}
		}
		...
		public class Adaptor : ClientLoginResultData, CrossBindingAdaptorType
		{
