...
using ShineEngine;
	...
	public class SceneLocationDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneLocationData);
			}
		}
		...
		public class Adaptor : SceneLocationData, CrossBindingAdaptorType
		{
