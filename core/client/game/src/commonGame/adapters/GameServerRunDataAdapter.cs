...
using ShineEngine;
	...
	public class GameServerRunDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(GameServerRunData);
			}
		}
		...
		public class Adaptor : GameServerRunData, CrossBindingAdaptorType
		{
