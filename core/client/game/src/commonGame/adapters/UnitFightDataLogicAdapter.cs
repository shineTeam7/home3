...
using ShineEngine;
	...
	public class UnitFightDataLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(UnitFightDataLogic);
			}
		}
		...
		public class Adaptor : UnitFightDataLogic, CrossBindingAdaptorType
		{
