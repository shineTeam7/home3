...
using ShineEngine;
	...
	public class EquipSlotTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(EquipSlotTypeConfig);
			}
		}
		...
		public class Adaptor : EquipSlotTypeConfig, CrossBindingAdaptorType
		{
