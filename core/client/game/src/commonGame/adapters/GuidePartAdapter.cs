...
using ShineEngine;
	...
	public class GuidePartAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(GuidePart);
			}
		}
		...
		public class Adaptor : GuidePart, CrossBindingAdaptorType
		{
			...
			bool _g20;
			bool _b20;
			public override void setMainStep(int value)
			{
				if(!_g20)
				{
					_m20=instance.Type.GetMethod("setMainStep",1);
					_g20=true;
				}
