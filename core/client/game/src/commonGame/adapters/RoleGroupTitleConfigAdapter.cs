...
using ShineEngine;
	...
	public class RoleGroupTitleConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleGroupTitleConfig);
			}
		}
		...
		public class Adaptor : RoleGroupTitleConfig, CrossBindingAdaptorType
		{
