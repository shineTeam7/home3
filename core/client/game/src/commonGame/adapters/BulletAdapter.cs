...
using ShineEngine;
	...
	public class BulletAdapter : CrossBindingAdaptor
	{
		...
		public class Adaptor : Bullet, CrossBindingAdaptorType
		{
			...
			protected override BulletPosLogic createPosLogic()
			{
				if(!_g7)
				{
					_m7=instance.Type.GetMethod("createPosLogic",0);
					_g7=true;
				}
				...
				{
					_b7=true;
					BulletPosLogic re=(BulletPosLogic)appdomain.Invoke(_m7,instance,null);
					_b7=false;
					return re;
