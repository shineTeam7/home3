...
using ShineEngine;
	...
	public class RoleGroupMemberDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(RoleGroupMemberData);
			}
		}
		...
		public class Adaptor : RoleGroupMemberData, CrossBindingAdaptorType
		{
