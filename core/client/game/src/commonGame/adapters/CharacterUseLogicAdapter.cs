...
using ShineEngine;
	...
	public class CharacterUseLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(CharacterUseLogic);
			}
		}
		...
		public class Adaptor : CharacterUseLogic, CrossBindingAdaptorType
		{
