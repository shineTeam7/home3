...
using ShineEngine;
	...
	public class SceneEnterArgDataAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneEnterArgData);
			}
		}
		...
		public class Adaptor : SceneEnterArgData, CrossBindingAdaptorType
		{
