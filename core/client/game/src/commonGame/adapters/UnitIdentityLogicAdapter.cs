...
using ShineEngine;
	...
	public class UnitIdentityLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(UnitIdentityLogic);
			}
		}
		...
		public class Adaptor : UnitIdentityLogic, CrossBindingAdaptorType
		{
