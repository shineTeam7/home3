...
using ShineEngine;
	...
	public class SceneForceTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(SceneForceTypeConfig);
			}
		}
		...
		public class Adaptor : SceneForceTypeConfig, CrossBindingAdaptorType
		{
