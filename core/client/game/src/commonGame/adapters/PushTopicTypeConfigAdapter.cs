...
using ShineEngine;
	...
	public class PushTopicTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(PushTopicTypeConfig);
			}
		}
		...
		public class Adaptor : PushTopicTypeConfig, CrossBindingAdaptorType
		{
