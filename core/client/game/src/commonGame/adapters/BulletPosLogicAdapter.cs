...
using ShineEngine;
	...
	public class BulletPosLogicAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(BulletPosLogic);
			}
		}
		...
		public class Adaptor : BulletPosLogic, CrossBindingAdaptorType
		{
			...
			protected override void initBullet()
			{
				if(!_g10)
				{
					_m10=instance.Type.GetMethod("initBullet",0);
					_g10=true;
				}
			...
			protected override void onBulletFrame(int delay)
			{
				if(!_g11)
				{
					_m11=instance.Type.GetMethod("onBulletFrame",1);
					_g11=true;
				}
			...
			bool _g12;
			bool _b12;
			protected override void getMoveDirectionBySelf(DirData re)
			{
				if(!_g12)
				{
					_m12=instance.Type.GetMethod("getMoveDirectionBySelf",1);
					_g12=true;
				}
				...
				{
					base.getMoveDirectionBySelf(re);
				}
			}
			...
			protected override void initPos()
			{
				if(!_g13)
				{
					_m13=instance.Type.GetMethod("initPos",0);
					_g13=true;
				}
			...
			bool _g14;
			bool _b14;
			protected override void getFrameHittedUnits(SList<Unit> list)
			{
				if(!_g14)
				{
					_m14=instance.Type.GetMethod("getFrameHittedUnits",1);
					_g14=true;
				}
