...
using ShineEngine;
	...
	public class UnitSpecialMoveTypeConfigAdapter : CrossBindingAdaptor
	{
		public override Type BaseCLRType
		{
			get
			{
				return typeof(UnitSpecialMoveTypeConfig);
			}
		}
		...
		public class Adaptor : UnitSpecialMoveTypeConfig, CrossBindingAdaptorType
		{
