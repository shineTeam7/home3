...
/// 背包容器插件
/// </summary>
public class PlayerItemContainerTool:ItemContainerTool,IPlayerFuncTool
{
	public Player me;

	public PlayerItemContainerTool(int funcID):base(funcID)
	{
	...
	protected override void toSendCleanUp()
	{
