...
public class Reporter : MonoBehaviour
{
	...
	public int numOfCircleToShow = 5;//两圈
	...
	public void Initialize()
	{
		...
		// show = (PlayerPrefs.GetInt("Reporter_show") == 1) ? true : false;//不启用
	...
	void drawToolBar()
	{
		...
		if (GUILayout.Button(resetContent, barStyle, GUILayout.Width(size.x * 2), GUILayout.Height(size.y * 2))) {
			GameC.ui.repoterAction(1);
		}
	...
	void Update() 
	{
		...
		fpsText=StringUtils.floorStrF2(fps);
	...
	void OnApplicationQuit()
	{
		...
		// PlayerPrefs.SetInt("Reporter_show", (show == true) ? 1 : 0);//不启用
 ...
 //
	...
	void OnHideReporter()
	{
		STouchControl.setInputEnbaled(true);
	}

	void OnShowReporter()
	{
		STouchControl.setInputEnbaled(false);
	}
}
